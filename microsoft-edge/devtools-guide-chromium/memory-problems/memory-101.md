...
*   Arborescence DOM du document, constituée de tous les nodes DOM natifs accessibles en parcourant le document.  Tous les nœuds n’ont pas de wrappers JavaScript, mais si un nœud possède un wrapper, le nœud est présent pendant que le document est en cours d’utilisation.  
