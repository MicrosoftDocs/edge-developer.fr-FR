...
### <a name="scripting-event-properties"></a><span data-ttu-id="430e9-193">Propriétés des événements de script</span><span class="sxs-lookup"><span data-stu-id="430e9-193">Scripting event properties</span></span>  
