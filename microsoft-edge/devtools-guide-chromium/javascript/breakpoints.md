...
# <a name="how-to-pause-your-code-with-breakpoints-in-microsoft-edge-devtools"></a>Comment suspendre votre code avec des points d’arrêt dans Microsoft Edge DevTools  

Utilisez des points d’arrêt pour suspendre votre code JavaScript.  Ce guide explique chaque type de point d’arrêt disponible dans DevTools, ainsi que quand utiliser et comment définir chaque type.  Pour un didacticiel pratique du processus de débogage, accédez à Commencer à déboguer JavaScript dans [Microsoft Edge DevTools][DevtoolsJavascriptIndex].  
