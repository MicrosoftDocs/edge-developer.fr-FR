...
1.  Dans le **volet Débogger,** sélectionnez Points d’arrêt de l’écoute d’événements pour développer la section. ****  DevTools révèle une liste de catégories d’événements ex expandables, telles que **Animation** et **Presse-papiers.**  
