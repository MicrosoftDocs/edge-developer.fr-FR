...
<span data-ttu-id="c98c0-125">Si la feuille de style est minified, voir [rendre un fichier minified lisible][DevToolsJavascriptReferenceFormat].</span><span class="sxs-lookup"><span data-stu-id="c98c0-125">If the stylesheet is minified, see [Make a minified file readable][DevToolsJavascriptReferenceFormat].</span></span>  
...
> ##### <span data-ttu-id="c98c0-151">Figure 4</span><span class="sxs-lookup"><span data-stu-id="c98c0-151">Figure 4</span></span>  
> <span data-ttu-id="c98c0-152">Diagramme de **modèle de cadre**</span><span class="sxs-lookup"><span data-stu-id="c98c0-152">The **Box Model** diagram</span></span>  
> ![Diagramme de modèle de cadre][ImageBoxModel]  

### <span data-ttu-id="c98c0-154">Rechercher et filtrer la CSS d’un élément</span><span class="sxs-lookup"><span data-stu-id="c98c0-154">Search and filter the CSS of an element</span></span>   

<span data-ttu-id="c98c0-155">Utilisez la zone de texte **filtre** des **styles** et des onglets **calculés** pour rechercher des propriétés ou des valeurs CSS spécifiques.</span><span class="sxs-lookup"><span data-stu-id="c98c0-155">Use the **Filter** text box on the **Styles** and **Computed** tabs to search for specific CSS properties or values.</span></span>  

<span data-ttu-id="c98c0-156">Pour effectuer une recherche dans les propriétés héritées dans l’onglet **calculé** , activez la case à cocher **Afficher tout** .</span><span class="sxs-lookup"><span data-stu-id="c98c0-156">To also search inherited properties in the **Computed** tab, check the **Show All** checkbox.</span></span>  

> [!NOTE]
> <span data-ttu-id="c98c0-157">Dans la [figure 5](#figure-5), l’onglet **styles** est filtré pour afficher uniquement les règles qui incluent la requête de recherche `color` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-157">In [Figure 5](#figure-5), the **Styles** tab is filtered to only show rules that include the search query `color`.</span></span>  

> ##### <span data-ttu-id="c98c0-158">Figure 5</span><span class="sxs-lookup"><span data-stu-id="c98c0-158">Figure 5</span></span>  
> <span data-ttu-id="c98c0-159">Filtrage de l’onglet **styles**</span><span class="sxs-lookup"><span data-stu-id="c98c0-159">Filtering the **Styles** tab</span></span>  
> ![Filtrage de l’onglet styles][ImageStylesFilter]  

> [!NOTE]
> <span data-ttu-id="c98c0-161">Dans la [figure 6](#figure-6), l’onglet **calculé** est filtré pour afficher uniquement les déclarations qui incluent la requête de recherche `100%` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-161">In [Figure 6](#figure-6), the **Computed** tab is filtered to only show declarations that include the search query `100%`.</span></span>  

> ##### <span data-ttu-id="c98c0-162">Figure 6</span><span class="sxs-lookup"><span data-stu-id="c98c0-162">Figure 6</span></span>  
> <span data-ttu-id="c98c0-163">Filtrage de l’onglet **calculé**</span><span class="sxs-lookup"><span data-stu-id="c98c0-163">Filtering the **Computed** tab</span></span>  
> ![Filtrage de l’onglet calculé][ImageComputerFilter]  

### <span data-ttu-id="c98c0-165">Basculer une pseudo-classe</span><span class="sxs-lookup"><span data-stu-id="c98c0-165">Toggle a pseudo-class</span></span>   

<span data-ttu-id="c98c0-166">Pour basculer une pseudo-classe comme `:active` , `:focus` , `:hover` ou `:visited` :</span><span class="sxs-lookup"><span data-stu-id="c98c0-166">To toggle a pseudo-class like `:active`, `:focus`, `:hover`, or `:visited`:</span></span>  

1.  <span data-ttu-id="c98c0-167">[Sélectionnez un élément](#select-an-element).</span><span class="sxs-lookup"><span data-stu-id="c98c0-167">[Select an element](#select-an-element).</span></span>  
1.  <span data-ttu-id="c98c0-168">Dans le panneau **éléments** , accédez à l’onglet **styles** .</span><span class="sxs-lookup"><span data-stu-id="c98c0-168">On the **Elements** panel, go to the **Styles** tab.</span></span>  
1.  <span data-ttu-id="c98c0-169">Cliquez sur **: HOV**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-169">Click **:hov**.</span></span>  
1.  <span data-ttu-id="c98c0-170">Vérifiez la pseudo-classe que vous souhaitez activer.</span><span class="sxs-lookup"><span data-stu-id="c98c0-170">Check the pseudo-class that you want to enable.</span></span>  
...
1.  <span data-ttu-id="c98c0-185">Commencez à taper `coverage` et sélectionnez **afficher la couverture**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-185">Start typing `coverage` and select **Show Coverage**.</span></span>  <span data-ttu-id="c98c0-186">L’onglet couverture apparaît.</span><span class="sxs-lookup"><span data-stu-id="c98c0-186">The Coverage tab appears.</span></span>  
    ...
    > ##### <span data-ttu-id="c98c0-187">Figure8</span><span class="sxs-lookup"><span data-stu-id="c98c0-187">Figure 8</span></span>  
    > <span data-ttu-id="c98c0-188">Ouverture de l’onglet couverture dans le menu de commandes</span><span class="sxs-lookup"><span data-stu-id="c98c0-188">Opening the Coverage tab from the Command Menu</span></span>  
    > ![Ouverture de l’onglet couverture dans le menu de commandes][ImageCommandMenu]  
    
    > ##### <span data-ttu-id="c98c0-190">Figure9</span><span class="sxs-lookup"><span data-stu-id="c98c0-190">Figure 9</span></span>  
    > <span data-ttu-id="c98c0-191">Onglet couverture</span><span class="sxs-lookup"><span data-stu-id="c98c0-191">The Coverage tab</span></span>  
    > ![Onglet couverture][ImageCoverageEmpty]  
    
1.  <span data-ttu-id="c98c0-193">Cliquez sur **Démarrer la couverture d’instrumentation et actualiser la page** de démarrage de l' ![ instrumentation et actualiser la page ][ImageRefreshIcon] .</span><span class="sxs-lookup"><span data-stu-id="c98c0-193">Click **Start instrumenting coverage and refresh the page** ![Start instrumenting coverage and refresh the page][ImageRefreshIcon].</span></span>  <span data-ttu-id="c98c0-194">La page actualise et l’onglet couverture fournit une vue d’ensemble de la quantité CSS \ (et JavaScript \) utilisée à partir de chaque fichier chargé par le navigateur.</span><span class="sxs-lookup"><span data-stu-id="c98c0-194">The page refreshes and the Coverage tab provides an overview of how much CSS \(and JavaScript\) is used from each file that the browser loads.</span></span>  <span data-ttu-id="c98c0-195">Green représente les feuilles CSS utilisées.</span><span class="sxs-lookup"><span data-stu-id="c98c0-195">Green represents used CSS.</span></span>  <span data-ttu-id="c98c0-196">Rouge représente les feuilles CSS inutilisées.</span><span class="sxs-lookup"><span data-stu-id="c98c0-196">Red represents unused CSS.</span></span>  
    
    > ##### <span data-ttu-id="c98c0-197">Figure10</span><span class="sxs-lookup"><span data-stu-id="c98c0-197">Figure 10</span></span>  
    > <span data-ttu-id="c98c0-198">Vue d’ensemble de la quantité d’utilisation et de la feuille de style CSS (JavaScript)</span><span class="sxs-lookup"><span data-stu-id="c98c0-198">An overview of how much CSS (and JavaScript) is used and unused</span></span>  
    > ![Vue d’ensemble de la quantité d’utilisation et de la feuille de style CSS (JavaScript)][ImageCoverageOverview]  

1.  <span data-ttu-id="c98c0-200">Cliquez sur un fichier CSS pour afficher une répartition ligne par ligne de la feuille de style CSS qu’il utilise.</span><span class="sxs-lookup"><span data-stu-id="c98c0-200">Click a CSS file to see a line-by-line breakdown of what CSS it uses.</span></span>  
    
    > [!NOTE]
    > <span data-ttu-id="c98c0-201">Dans la [figure 11](#figure-11), les lignes 145 à 147 et 149 à 151 `b66bc881.site-ltr.css` sont inutilisées, alors que les lignes 163 à 166 sont utilisées.</span><span class="sxs-lookup"><span data-stu-id="c98c0-201">In [Figure 11](#figure-11), lines 145 to 147 and 149 to 151 of `b66bc881.site-ltr.css` are unused, whereas lines 163 to 166 are used.</span></span>  
    
    > ##### <span data-ttu-id="c98c0-202">Figure11</span><span class="sxs-lookup"><span data-stu-id="c98c0-202">Figure 11</span></span>  
    > <span data-ttu-id="c98c0-203">Une répartition ligne par ligne de feuilles CSS utilisées et inutilisées</span><span class="sxs-lookup"><span data-stu-id="c98c0-203">A line-by-line breakdown of used and unused CSS</span></span>  
    > ![Une répartition ligne par ligne de feuilles CSS utilisées et inutilisées][ImageCoverageDetail]  
    
### <span data-ttu-id="c98c0-205">Forcer le mode aperçu avant impression</span><span class="sxs-lookup"><span data-stu-id="c98c0-205">Force print preview mode</span></span>   

<span data-ttu-id="c98c0-206">Pour plus d’DevTools, voir [mode aperçu avant impression][DevToolsCssPrintPreview].</span><span class="sxs-lookup"><span data-stu-id="c98c0-206">See [Force DevTools Into Print Preview Mode][DevToolsCssPrintPreview].</span></span>  
...
<span data-ttu-id="c98c0-219">Pour ajouter une déclaration en ligne:</span><span class="sxs-lookup"><span data-stu-id="c98c0-219">To add an inline declaration:</span></span>  
...
> ##### <span data-ttu-id="c98c0-238">Figure13</span><span class="sxs-lookup"><span data-stu-id="c98c0-238">Figure 13</span></span>  
> <span data-ttu-id="c98c0-239">Ajout `border-bottom-style:groove` de la déclaration à une règle de style</span><span class="sxs-lookup"><span data-stu-id="c98c0-239">Adding the `border-bottom-style:groove` declaration to a style rule</span></span>  
> ![Ajout d’une déclaration à une règle de style][ImageAddDeclarationExistingRule]  

### <span data-ttu-id="c98c0-241">Modifier le nom ou la valeur d’une déclaration</span><span class="sxs-lookup"><span data-stu-id="c98c0-241">Change a declaration name or value</span></span>   

<span data-ttu-id="c98c0-242">Double-cliquez sur le nom ou la valeur d’une déclaration pour la modifier.</span><span class="sxs-lookup"><span data-stu-id="c98c0-242">Double-click the name or value of a declaration to change it.</span></span>  <span data-ttu-id="c98c0-243">Voir [modifier les valeurs de déclaration avec des raccourcis clavier](#change-declaration-values-with-keyboard-shortcuts) pour les raccourcis permettant d’incrémenter ou de décrémenter rapidement une valeur par `0.1` ,, ou par `1` `10` `100` unités.</span><span class="sxs-lookup"><span data-stu-id="c98c0-243">See [Change declaration values with keyboard shortcuts](#change-declaration-values-with-keyboard-shortcuts) for shortcuts for quickly incrementing or decrementing a value by `0.1`, `1`, `10`, or `100` units.</span></span>  

> ##### <span data-ttu-id="c98c0-244">Figure14</span><span class="sxs-lookup"><span data-stu-id="c98c0-244">Figure 14</span></span>  
> <span data-ttu-id="c98c0-245">Modification de la valeur de l’argument</span><span class="sxs-lookup"><span data-stu-id="c98c0-245">Changing the value of the</span></span> `border-bottom-style`  
> ![Modification de la valeur d’une déclaration][ImageAddDeclarationExistingRule2]  

### <span data-ttu-id="c98c0-247">Modification des valeurs de déclaration avec les raccourcis clavier</span><span class="sxs-lookup"><span data-stu-id="c98c0-247">Change declaration values with keyboard shortcuts</span></span>   

<span data-ttu-id="c98c0-248">Lors de la modification de la valeur d’une déclaration, vous pouvez utiliser les raccourcis clavier suivants pour incrémenter la valeur à l’aide d’un montant fixe:</span><span class="sxs-lookup"><span data-stu-id="c98c0-248">While editing the value of a declaration, you may use the following keyboard shortcuts to increment the value by a fixed amount:</span></span>  

*   <span data-ttu-id="c98c0-249">Appuyez sur `Alt` + `Up` \ (Windows \) ou `Option` + `Up` \ (MacOS \) pour incrémenter par `0.1` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-249">Press `Alt`+`Up` \(Windows\) or `Option`+`Up` \(macOS\) to increment by `0.1`.</span></span>  
*   <span data-ttu-id="c98c0-250">Appuyez sur `Up` pour modifier la valeur par `1` , ou `0.1` si la valeur actuelle est comprise entre `-1` et `1` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-250">Press `Up` to change the value by `1`, or by `0.1` if the current value is between `-1` and `1`.</span></span>  
*   <span data-ttu-id="c98c0-251">Appuyez sur `Shift` + `Up` pour incrémenter par `10` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-251">Press `Shift`+`Up` to increment by `10`.</span></span>  
*   <span data-ttu-id="c98c0-252">Appuyez sur `Shift` + `Page Up` \ (Windows \) ou `Shift` + `Command` + `Up` \ (MacOS \) pour incrémenter la valeur `100` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-252">Press `Shift`+`Page Up` \(Windows\) or `Shift`+`Command`+`Up` \(macOS\) to increment the value by `100`.</span></span>  

<span data-ttu-id="c98c0-253">La décrémentation fonctionne également.</span><span class="sxs-lookup"><span data-stu-id="c98c0-253">Decrementing also works.</span></span>  <span data-ttu-id="c98c0-254">Il vous suffit de remplacer chaque instance décrite `Up` plus haut par `Down` .</span><span class="sxs-lookup"><span data-stu-id="c98c0-254">Just replace each instance of `Up` mentioned above with `Down`.</span></span>  
...
### <span data-ttu-id="c98c0-271">Ajouter une règle de style</span><span class="sxs-lookup"><span data-stu-id="c98c0-271">Add a style rule</span></span>   
...
1.  <span data-ttu-id="c98c0-287">Pointez sur la règle de style qui se trouve directement au-dessus de l’endroit où vous souhaitez ajouter votre nouvelle règle de style.</span><span class="sxs-lookup"><span data-stu-id="c98c0-287">Hover over the style rule that is directly above where you want to add your new style rule.</span></span>  
1.  <span data-ttu-id="c98c0-288">[Afficher la barre d’outils **plus d’actions** ](#reveal-the-more-actions-toolbar).</span><span class="sxs-lookup"><span data-stu-id="c98c0-288">[Reveal the **More Actions** toolbar](#reveal-the-more-actions-toolbar).</span></span>  
1.  <span data-ttu-id="c98c0-289">Cliquez sur **Insérer une règle de style sous** ![ Insérer une règle de style ci-dessous ][ImageNewStyleRuleIcon] .</span><span class="sxs-lookup"><span data-stu-id="c98c0-289">Click **Insert Style Rule Below** ![Insert Style Rule Below][ImageNewStyleRuleIcon].</span></span>  

> ##### <span data-ttu-id="c98c0-290">Figure 18</span><span class="sxs-lookup"><span data-stu-id="c98c0-290">Figure 18</span></span>  
> **<span data-ttu-id="c98c0-291">Insérer une règle de style en dessous</span><span class="sxs-lookup"><span data-stu-id="c98c0-291">Insert Style Rule Below</span></span>**  
> ![Insérer une règle de style en dessous][ImageInsertStyleRuleBelow]  

### <span data-ttu-id="c98c0-293">Afficher la barre d’outils plus d’actions</span><span class="sxs-lookup"><span data-stu-id="c98c0-293">Reveal the More Actions toolbar</span></span>   

<span data-ttu-id="c98c0-294">La barre d’outils **plus d’actions** vous permet d’effectuer les opérations suivantes:</span><span class="sxs-lookup"><span data-stu-id="c98c0-294">The **More Actions** toolbar lets you:</span></span>  

*   <span data-ttu-id="c98c0-295">Insérez une règle de style juste en dessous de celle qui vous intéresse.</span><span class="sxs-lookup"><span data-stu-id="c98c0-295">Insert a style rule directly below the one you are focused on.</span></span>  
*   <span data-ttu-id="c98c0-296">Ajoutez une `background-color` `color` `box-shadow` `text-shadow` déclaration à la règle de style sur laquelle vous êtes prioritaire.</span><span class="sxs-lookup"><span data-stu-id="c98c0-296">Add a `background-color`, `color`, `box-shadow`, or `text-shadow` declaration to the style rule you are focused on.</span></span>  

<span data-ttu-id="c98c0-297">Pour afficher la barre d’outils **plus d’actions** :</span><span class="sxs-lookup"><span data-stu-id="c98c0-297">To reveal the **More Actions** toolbar:</span></span>  

1.  <span data-ttu-id="c98c0-298">Dans l’onglet **styles** , pointez sur une règle de style.</span><span class="sxs-lookup"><span data-stu-id="c98c0-298">In the **Styles** tab, hover over a style rule.</span></span>  <span data-ttu-id="c98c0-299">**Plus d’actions** `...` est affiché dans le coin inférieur droit de la section règle de style.</span><span class="sxs-lookup"><span data-stu-id="c98c0-299">**More Actions** `...` is revealed in the bottom-right of the style rule section.</span></span>  
    
    > [!NOTE]
    > <span data-ttu-id="c98c0-300">Dans la [figure 19](#figure-19), placez le pointeur sur la `.header-holder.has-default-focus` règle de style et d' **autres actions** sont affichées dans le coin inférieur droit de la section règle de style.</span><span class="sxs-lookup"><span data-stu-id="c98c0-300">In [Figure 19](#figure-19), hover over the `.header-holder.has-default-focus` style rule and **More Actions** is revealed in the bottom-right of the style rule section.</span></span>  
    
    > ##### <span data-ttu-id="c98c0-301">Figure 19</span><span class="sxs-lookup"><span data-stu-id="c98c0-301">Figure 19</span></span>  
    > <span data-ttu-id="c98c0-302">Affichage **plus d’actions**</span><span class="sxs-lookup"><span data-stu-id="c98c0-302">Revealing **More Actions**</span></span>  
    > ![Affichage plus d’actions][ImageRevealMore]  
    
1.  <span data-ttu-id="c98c0-304">Placez le pointeur sur **plus d’actions** `...` pour afficher les actions mentionnées ci-dessus.</span><span class="sxs-lookup"><span data-stu-id="c98c0-304">Hover over **More Actions** `...` to reveal the actions mentioned above.</span></span>  
    
    > [!NOTE]
    > <span data-ttu-id="c98c0-305">L’action **Insérer une règle de style ci-dessous** apparaît après avoir pointé sur **plus d’actions**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-305">The **Insert Style Rule Below** action is revealed after hovering over **More Actions**.</span></span>  
    
    > ##### <span data-ttu-id="c98c0-306">Figure 20</span><span class="sxs-lookup"><span data-stu-id="c98c0-306">Figure 20</span></span>  
    > <span data-ttu-id="c98c0-307">Barre d’outils **plus d’actions**</span><span class="sxs-lookup"><span data-stu-id="c98c0-307">The **More Actions** toolbar</span></span>  
    > ![Barre d’outils plus d’actions][ImageInsertStyleRuleBelow2]  
    
### <span data-ttu-id="c98c0-309">Basculer une déclaration</span><span class="sxs-lookup"><span data-stu-id="c98c0-309">Toggle a declaration</span></span>   

<span data-ttu-id="c98c0-310">Pour activer ou désactiver une déclaration unique:</span><span class="sxs-lookup"><span data-stu-id="c98c0-310">To toggle a single declaration on or off:</span></span>  

1.  <span data-ttu-id="c98c0-311">[Sélectionnez un élément](#select-an-element).</span><span class="sxs-lookup"><span data-stu-id="c98c0-311">[Select an element](#select-an-element).</span></span>  
1.  <span data-ttu-id="c98c0-312">Dans le volet **styles** , pointez sur la règle qui définit la déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-312">In the **Styles** pane, hover over the rule that defines the declaration.</span></span>  <span data-ttu-id="c98c0-313">Les cases à cocher s’affichent en regard de chaque déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-313">Checkboxes appear next to each declaration.</span></span>  
1.  <span data-ttu-id="c98c0-314">Activez ou désactivez la case à cocher en regard de la déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-314">Check or uncheck the checkbox next to the declaration.</span></span>  <span data-ttu-id="c98c0-315">Lorsque vous décochez une déclaration, DevTools la traverse pour indiquer qu’elle n’est plus active.</span><span class="sxs-lookup"><span data-stu-id="c98c0-315">When you uncheck a declaration, DevTools crosses it out to indicate that it is no longer active.</span></span>  

> [!NOTE]
> <span data-ttu-id="c98c0-316">Dans la [figure 21](#figure-21), la `margin-top` propriété de l’élément actuellement sélectionné a été activée.</span><span class="sxs-lookup"><span data-stu-id="c98c0-316">In [Figure 21](#figure-21), the `margin-top` property for the currently selected element has been toggled off.</span></span>  

> ##### <span data-ttu-id="c98c0-317">Figure 21</span><span class="sxs-lookup"><span data-stu-id="c98c0-317">Figure 21</span></span>  
> <span data-ttu-id="c98c0-318">Basculer une déclaration</span><span class="sxs-lookup"><span data-stu-id="c98c0-318">Toggling a declaration</span></span>  
> ![Basculer une déclaration][ImageToggleDeclaration]  

### <span data-ttu-id="c98c0-320">Ajouter une déclaration couleur d’arrière-plan</span><span class="sxs-lookup"><span data-stu-id="c98c0-320">Add a background-color declaration</span></span>   

<span data-ttu-id="c98c0-321">Pour ajouter une `background-color` déclaration à un élément:</span><span class="sxs-lookup"><span data-stu-id="c98c0-321">To add a `background-color` declaration to an element:</span></span>  

1.  <span data-ttu-id="c98c0-322">Pointez sur la règle de style à laquelle vous souhaitez ajouter la `background-color` déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-322">Hover over the style rule that you want to add the `background-color` declaration to.</span></span>  
1.  <span data-ttu-id="c98c0-323">[Afficher la barre d’outils **plus d’actions** ](#reveal-the-more-actions-toolbar).</span><span class="sxs-lookup"><span data-stu-id="c98c0-323">[Reveal the **More Actions** toolbar](#reveal-the-more-actions-toolbar).</span></span>  
1.  <span data-ttu-id="c98c0-324">Cliquez sur **Ajouter une couleur d’arrière-** ![ plan ajouter une couleur d’arrière-plan ][ImageAddBackgroundColorIcon] .</span><span class="sxs-lookup"><span data-stu-id="c98c0-324">Click **Add Background Color** ![Add Background Color][ImageAddBackgroundColorIcon].</span></span>  

> ##### <span data-ttu-id="c98c0-325">Figure 22</span><span class="sxs-lookup"><span data-stu-id="c98c0-325">Figure 22</span></span>  
> **<span data-ttu-id="c98c0-326">Ajouter une couleur d’arrière-plan</span><span class="sxs-lookup"><span data-stu-id="c98c0-326">Add Background Color</span></span>**  
> ![Ajouter une couleur d’arrière-plan][ImageAddBackgroundColor]  

### <span data-ttu-id="c98c0-328">Ajouter une déclaration de couleur</span><span class="sxs-lookup"><span data-stu-id="c98c0-328">Add a color declaration</span></span>   

<span data-ttu-id="c98c0-329">Pour ajouter une `color` déclaration à un élément:</span><span class="sxs-lookup"><span data-stu-id="c98c0-329">To add a `color` declaration to an element:</span></span>  

1.  <span data-ttu-id="c98c0-330">Pointez sur la règle de style à laquelle vous souhaitez ajouter la `color` déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-330">Hover over the style rule that you want to add the `color` declaration to.</span></span>  
1.  <span data-ttu-id="c98c0-331">[Afficher la barre d’outils **plus d’actions** ](#reveal-the-more-actions-toolbar).</span><span class="sxs-lookup"><span data-stu-id="c98c0-331">[Reveal the **More Actions** toolbar](#reveal-the-more-actions-toolbar).</span></span>  
1.  <span data-ttu-id="c98c0-332">Cliquez sur **Ajouter** une couleur ajouter une couleur ![ ][ImageAddColorIcon] .</span><span class="sxs-lookup"><span data-stu-id="c98c0-332">Click **Add Color** ![Add Color][ImageAddColorIcon].</span></span>  

> ##### <span data-ttu-id="c98c0-333">Figure 23</span><span class="sxs-lookup"><span data-stu-id="c98c0-333">Figure 23</span></span>  
> **<span data-ttu-id="c98c0-334">Ajouter de la couleur</span><span class="sxs-lookup"><span data-stu-id="c98c0-334">Add Color</span></span>**  
> ![Ajouter de la couleur][ImageAddColor]  

### <span data-ttu-id="c98c0-336">Ajouter une déclaration d’ombre Box</span><span class="sxs-lookup"><span data-stu-id="c98c0-336">Add a box-shadow declaration</span></span>   

<span data-ttu-id="c98c0-337">Pour ajouter une `box-shadow` déclaration à un élément:</span><span class="sxs-lookup"><span data-stu-id="c98c0-337">To add a `box-shadow` declaration to an element:</span></span>  

1.  <span data-ttu-id="c98c0-338">Pointez sur la règle de style à laquelle vous souhaitez ajouter la `box-shadow` déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-338">Hover over the style rule that you want to add the `box-shadow` declaration to.</span></span>  
1.  <span data-ttu-id="c98c0-339">[Afficher la barre d’outils **plus d’actions** ](#reveal-the-more-actions-toolbar).</span><span class="sxs-lookup"><span data-stu-id="c98c0-339">[Reveal the **More Actions** toolbar](#reveal-the-more-actions-toolbar).</span></span>  
1.  <span data-ttu-id="c98c0-340">Cliquez sur **Ajouter** une ombre de zone Ajouter une ombre ![ ][ImageAddBoxShadowIcon] .</span><span class="sxs-lookup"><span data-stu-id="c98c0-340">Click **Add Box Shadow** ![Add Box Shadow][ImageAddBoxShadowIcon].</span></span>  

> ##### <span data-ttu-id="c98c0-341">Figure 24</span><span class="sxs-lookup"><span data-stu-id="c98c0-341">Figure 24</span></span>  
> **<span data-ttu-id="c98c0-342">Ajouter une ombre de zone</span><span class="sxs-lookup"><span data-stu-id="c98c0-342">Add Box Shadow</span></span>**  
> ![Ajouter une ombre de zone][ImageAddBoxShadow]  

### <span data-ttu-id="c98c0-344">Ajouter une déclaration d’ombre textuelle</span><span class="sxs-lookup"><span data-stu-id="c98c0-344">Add a text-shadow declaration</span></span>   

<span data-ttu-id="c98c0-345">Pour ajouter une `text-shadow` déclaration à un élément:</span><span class="sxs-lookup"><span data-stu-id="c98c0-345">To add a `text-shadow` declaration to an element:</span></span>  

1.  <span data-ttu-id="c98c0-346">Pointez sur la règle de style à laquelle vous souhaitez ajouter la `text-shadow` déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-346">Hover over the style rule that you want to add the `text-shadow` declaration to.</span></span>  
1.  <span data-ttu-id="c98c0-347">[Afficher la barre d’outils **plus d’actions** ](#reveal-the-more-actions-toolbar).</span><span class="sxs-lookup"><span data-stu-id="c98c0-347">[Reveal the **More Actions** toolbar](#reveal-the-more-actions-toolbar).</span></span>  
1.  <span data-ttu-id="c98c0-348">Cliquez sur **Ajouter une ombre du texte** ![ Ajouter une ombre ][ImageAddTextShadowIcon] .</span><span class="sxs-lookup"><span data-stu-id="c98c0-348">Click **Add Text Shadow** ![Add Text Shadow][ImageAddTextShadowIcon].</span></span>  

> ##### <span data-ttu-id="c98c0-349">Figure 25</span><span class="sxs-lookup"><span data-stu-id="c98c0-349">Figure 25</span></span>  
> **<span data-ttu-id="c98c0-350">Ajouter une ombre de texte</span><span class="sxs-lookup"><span data-stu-id="c98c0-350">Add Text Shadow</span></span>**  
> ![Ajouter une ombre de texte][ImageAddTextShadow]  

### <span data-ttu-id="c98c0-352">Changer les couleurs à l’aide du sélecteur de couleurs</span><span class="sxs-lookup"><span data-stu-id="c98c0-352">Change colors with the Color Picker</span></span>   

<span data-ttu-id="c98c0-353">Le **Sélecteur de couleurs** fournit une interface utilisateur pour le changement `color` et la `background-color` déclaration.</span><span class="sxs-lookup"><span data-stu-id="c98c0-353">The **Color Picker** provides a GUI for changing `color` and `background-color` declarations.</span></span>  

<span data-ttu-id="c98c0-354">Pour ouvrir le **Sélecteur de couleurs**:</span><span class="sxs-lookup"><span data-stu-id="c98c0-354">To open the **Color Picker**:</span></span>  

1.  <span data-ttu-id="c98c0-355">[Sélectionnez un élément](#select-an-element).</span><span class="sxs-lookup"><span data-stu-id="c98c0-355">[Select an element](#select-an-element).</span></span>  
1.  <span data-ttu-id="c98c0-356">Dans l’onglet **styles** , recherchez la `color` `background-color` déclaration, ou similaire, que vous voulez modifier.</span><span class="sxs-lookup"><span data-stu-id="c98c0-356">In the **Styles** tab, find the `color`, `background-color`, or similar declaration that you want to change.</span></span>  <span data-ttu-id="c98c0-357">À gauche de la `color` valeur, `background-color` ou similaire, il existe un petit carré, qui est un aperçu de la couleur.</span><span class="sxs-lookup"><span data-stu-id="c98c0-357">To the left of the `color`, `background-color`, or similar value, there is a small square which is a preview of the color.</span></span>  
    
    > [!NOTE]
    > <span data-ttu-id="c98c0-358">Dans la [figure 26](#figure-26), le petit carré à gauche de `rgba(0, 0, 0, 0.7)` est un aperçu de cette couleur.</span><span class="sxs-lookup"><span data-stu-id="c98c0-358">In [Figure 26](#figure-26), the small square to the left of `rgba(0, 0, 0, 0.7)` is a preview of that color.</span></span>  
    
    > ##### <span data-ttu-id="c98c0-359">Figure 26</span><span class="sxs-lookup"><span data-stu-id="c98c0-359">Figure 26</span></span>  
    > <span data-ttu-id="c98c0-360">Aperçu de couleur</span><span class="sxs-lookup"><span data-stu-id="c98c0-360">Color preview</span></span>  
    > ![Aperçu de couleur][ImageColorPreview]  
    
1.  <span data-ttu-id="c98c0-362">Cliquez sur l’Aperçu pour ouvrir le **Sélecteur de couleurs**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-362">Click the preview to open the **Color Picker**.</span></span>  
    
    > ##### <span data-ttu-id="c98c0-363">Figure 27</span><span class="sxs-lookup"><span data-stu-id="c98c0-363">Figure 27</span></span>  
    > <span data-ttu-id="c98c0-364">**Sélecteur de couleurs**</span><span class="sxs-lookup"><span data-stu-id="c98c0-364">The **Color Picker**</span></span>  
    > ![Sélecteur de couleurs][ImageColorPicker]  
    
<span data-ttu-id="c98c0-366">Voici une description de chaque élément d’interface utilisateur du sélecteur de **couleurs**:</span><span class="sxs-lookup"><span data-stu-id="c98c0-366">Here is a description of each of the UI elements of the **Color Picker**:</span></span>  

> ##### <span data-ttu-id="c98c0-367">Figure 28</span><span class="sxs-lookup"><span data-stu-id="c98c0-367">Figure 28</span></span>  
> <span data-ttu-id="c98c0-368">Sélecteur de couleurs, annoté</span><span class="sxs-lookup"><span data-stu-id="c98c0-368">The Color Picker, annotated</span></span>  
> ![Sélecteur de couleurs, annoté][ImageColorPickerAnnotated]  

1.  <span data-ttu-id="c98c0-370">**Nuances de gris**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-370">**Shades**.</span></span>  
1.  <span data-ttu-id="c98c0-371">**Pipette**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-371">**Eyedropper**.</span></span>  <span data-ttu-id="c98c0-372">Pour en savoir plus, voir [exemple de couleur de la page avec le](#sample-a-color-off-the-page-with-the-eyedropper)compte-gouttes.</span><span class="sxs-lookup"><span data-stu-id="c98c0-372">See [Sample a color off the page with the Eyedropper](#sample-a-color-off-the-page-with-the-eyedropper).</span></span>  
1.  <span data-ttu-id="c98c0-373">**Copier dans le presse-papiers**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-373">**Copy To Clipboard**.</span></span>  <span data-ttu-id="c98c0-374">Copiez la **valeur d’affichage** dans le presse-papiers.</span><span class="sxs-lookup"><span data-stu-id="c98c0-374">Copy the **Display Value** to your clipboard.</span></span>  
1.  <span data-ttu-id="c98c0-375">**Valeur d’affichage**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-375">**Display Value**.</span></span>  <span data-ttu-id="c98c0-376">La représentation RVBA, HSLA ou Hex de la couleur.</span><span class="sxs-lookup"><span data-stu-id="c98c0-376">The RGBA, HSLA, or Hex representation of the color.</span></span>  
1.  <span data-ttu-id="c98c0-377">**Palette de couleurs**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-377">**Color Palette**.</span></span>  <span data-ttu-id="c98c0-378">Cliquez sur l’un de ces carrés pour modifier la couleur de ce carré.</span><span class="sxs-lookup"><span data-stu-id="c98c0-378">Click one of these squares to change the color to that square.</span></span>  
1.  <span data-ttu-id="c98c0-379">**Nuance**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-379">**Hue**.</span></span>  
1.  <span data-ttu-id="c98c0-380">**Opacity**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-380">**Opacity**.</span></span>  
1.  <span data-ttu-id="c98c0-381">**Sélecteur de valeurs d’affichage**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-381">**Display Value Switcher**.</span></span>  <span data-ttu-id="c98c0-382">Basculer entre les représentations RVBA, HSLA et Hex de la couleur actuelle.</span><span class="sxs-lookup"><span data-stu-id="c98c0-382">Toggle between the RGBA, HSLA, and Hex representations of the current color.</span></span>  
1.  <span data-ttu-id="c98c0-383">**Sélecteur de palette de couleurs**.</span><span class="sxs-lookup"><span data-stu-id="c98c0-383">**Color Palette Switcher**.</span></span>  <span data-ttu-id="c98c0-384">Basculer entre la [palette de création matérielle][MaterialDesignColorSystem], une palette personnalisée ou une palette de couleurs de page.</span><span class="sxs-lookup"><span data-stu-id="c98c0-384">Toggle between the [Material Design palette][MaterialDesignColorSystem], a custom palette, or a page colors palette.</span></span>  <span data-ttu-id="c98c0-385">DevTools génère la palette de couleurs de page en fonction des couleurs qu’il trouve dans vos feuilles de style.</span><span class="sxs-lookup"><span data-stu-id="c98c0-385">DevTools generates the page color palette based on the colors that it finds in your stylesheets.</span></span>  
