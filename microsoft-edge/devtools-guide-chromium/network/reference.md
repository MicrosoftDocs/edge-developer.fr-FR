...
<span data-ttu-id="594f0-179">Si la zone de texte n’est pas affichée, le volet **Filtres** est probablement masqué.</span><span class="sxs-lookup"><span data-stu-id="594f0-179">If the text box is not displayed, the **Filters** pane is probably hidden.</span></span>  
...
## <a name="sort-requests"></a><span data-ttu-id="594f0-244">Trier les demandes</span><span class="sxs-lookup"><span data-stu-id="594f0-244">Sort requests</span></span>  
...
:::row:::
   :::column span="1":::
      **<span data-ttu-id="594f0-256">Durée totale</span><span class="sxs-lookup"><span data-stu-id="594f0-256">Total Duration</span></span>**  
   :::column-end:::
   :::column span="2":::
...
<span data-ttu-id="594f0-268">Utilisez la table Requests pour afficher un journal de toutes les demandes réalisées alors que DevTools a été ouvert.</span><span class="sxs-lookup"><span data-stu-id="594f0-268">Use the Requests table to display a log of all requests made while DevTools have been open.</span></span>  <span data-ttu-id="594f0-269">Pour révéler plus d’informations sur chaque élément, choisissez ou pointez sur les demandes.</span><span class="sxs-lookup"><span data-stu-id="594f0-269">To reveals more information about each item, choose or hover on requests.</span></span>  
...
:::row:::
   ...
   :::column span="2":::
      ...
      *   <span data-ttu-id="594f0-281">**Parser**  L’en-tête HTML pour Microsoft Edge.</span><span class="sxs-lookup"><span data-stu-id="594f0-281">**Parser**  The HTML parser for Microsoft Edge.</span></span>  
...
### <a name="display-http-headers"></a><span data-ttu-id="594f0-320">Afficher les en-têtes HTTP</span><span class="sxs-lookup"><span data-stu-id="594f0-320">Display HTTP headers</span></span>  
...
### <a name="display-cookies"></a><span data-ttu-id="594f0-349">Afficher les cookies</span><span class="sxs-lookup"><span data-stu-id="594f0-349">Display cookies</span></span>  
...
<span data-ttu-id="594f0-363">Plus d’informations sur chacune des phases.</span><span class="sxs-lookup"><span data-stu-id="594f0-363">More information about each of the phases.</span></span>  
...
:::row:::
   :::column span="1":::
      **<span data-ttu-id="594f0-378">Bloqué</span><span class="sxs-lookup"><span data-stu-id="594f0-378">Stalled</span></span>**  
   :::column-end:::
   :::column span="2":::
...
### <a name="display-initiators-and-dependencies"></a><span data-ttu-id="594f0-402">Afficher les initiateurs et les dépendances</span><span class="sxs-lookup"><span data-stu-id="594f0-402">Display initiators and dependencies</span></span>  
...
### <a name="display-the-stack-trace-that-caused-a-request"></a><span data-ttu-id="594f0-429">Afficher la trace de pile à l’origine d’une demande</span><span class="sxs-lookup"><span data-stu-id="594f0-429">Display the stack trace that caused a request</span></span>  
...
<span data-ttu-id="594f0-439">Pour enregistrer toutes les demandes réseau dans un fichier HAR, complétez les étapes suivantes.</span><span class="sxs-lookup"><span data-stu-id="594f0-439">To save all network requests to a HAR file, complete the following steps.</span></span>  
...
| **<span data-ttu-id="594f0-463">Copier tout en tant que HAR</span><span class="sxs-lookup"><span data-stu-id="594f0-463">Copy All as HAR</span></span>** | <span data-ttu-id="594f0-464">Copiez toutes les demandes en tant que données HAR.</span><span class="sxs-lookup"><span data-stu-id="594f0-464">Copy all requests as HAR data.</span></span> |  
...
:::image type="complex" source="../media/network-network-requests-copy-response.msft.png" alt-text="Choose Copy Response" lightbox="../media/network-network-requests-copy-response.msft.png":::
   <span data-ttu-id="594f0-466">Choose **Copy Response**</span><span class="sxs-lookup"><span data-stu-id="594f0-466">Choose **Copy Response**</span></span>  
:::image-end:::  

### <a name="copy-formatted-response-json-to-the-clipboard"></a><span data-ttu-id="594f0-467">Copier la réponse mise en forme JSON dans le Presse-papiers</span><span class="sxs-lookup"><span data-stu-id="594f0-467">Copy formatted response JSON to the clipboard</span></span>  

<span data-ttu-id="594f0-468">Choisissez une demande réseau et accédez au volet **En-têtes.**</span><span class="sxs-lookup"><span data-stu-id="594f0-468">Choose a network request and navigate to the **Headers** pane.</span></span>  <span data-ttu-id="594f0-469">Pour copier la valeur JSON d’une réponse, accédez à Charge utile de la **demande,** pointez sur le contenu de la réponse JSON, ouvrez le menu contextuel \(clic droit\), puis choisissez Copier la **valeur**.</span><span class="sxs-lookup"><span data-stu-id="594f0-469">To copy the JSON value of a response, navigate to **Request payload**, hover on the JSON response content, open the contextual menu \(right-click\), and choose **Copy Value**.</span></span>  
...
:::row:::
   :::column span="":::
        :::image type="complex" source="../media/network-header-copy-property-value.msft.png" alt-text="Copier la valeur dans le menu contextuel" lightbox="../media/network-header-copy-property-value.msft.png":::
          <span data-ttu-id="594f0-471">**Copier la valeur** dans le menu contextuel</span><span class="sxs-lookup"><span data-stu-id="594f0-471">**Copy Value** in contextual menu</span></span>  
        :::image-end:::  
   :::column-end:::
   :::column span="":::
        :::image type="complex" source="../media/network-header-paste-property-value.msft.png" alt-text="Code microsoft Visual Studio avec réponse mise en forme JSON" lightbox="../media/network-header-paste-property-value.msft.png":::
          <span data-ttu-id="594f0-473">Pasting formatted response JSON in Microsoft Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="594f0-473">Pasting formatted response JSON in Microsoft Visual Studio Code</span></span>  
        :::image-end:::  
   :::column-end:::
:::row-end:::  

### <a name="copy-property-values-from-network-requests-to-your-clipboard"></a><span data-ttu-id="594f0-474">Copier les valeurs des propriétés des demandes réseau dans votre Presse-papiers</span><span class="sxs-lookup"><span data-stu-id="594f0-474">Copy property values from network requests to your clipboard</span></span>  

<span data-ttu-id="594f0-475">Pour copier les valeurs de propriétés des demandes réseau dans votre Presse-papiers, effectuer les actions suivantes.</span><span class="sxs-lookup"><span data-stu-id="594f0-475">To copy property values from network requests to your clipboard, complete the following actions.</span></span>  

1.  <span data-ttu-id="594f0-476">Ouvrez **le volet En-têtes.**</span><span class="sxs-lookup"><span data-stu-id="594f0-476">Open the **Headers** pane.</span></span>  
1.  <span data-ttu-id="594f0-477">Ouvrez l’une des sections d’en-tête suivantes.</span><span class="sxs-lookup"><span data-stu-id="594f0-477">Open one of the following header sections.</span></span>  
    *   <span data-ttu-id="594f0-478">Demander la charge utile \(JSON\)</span><span class="sxs-lookup"><span data-stu-id="594f0-478">Request payload \(JSON\)</span></span>  
    *   <span data-ttu-id="594f0-479">Données de formulaire</span><span class="sxs-lookup"><span data-stu-id="594f0-479">Form Data</span></span>  
    *   <span data-ttu-id="594f0-480">Paramètres de chaîne de requête</span><span class="sxs-lookup"><span data-stu-id="594f0-480">Query String Parameters</span></span>  
    *   <span data-ttu-id="594f0-481">En-têtes de requête</span><span class="sxs-lookup"><span data-stu-id="594f0-481">Request Headers</span></span>  
    *   <span data-ttu-id="594f0-482">En-têtes de réponse</span><span class="sxs-lookup"><span data-stu-id="594f0-482">Response Headers</span></span>  
1.  <span data-ttu-id="594f0-483">Ouvrez le menu contextuel \(clic droit\) > **valeur copier.**</span><span class="sxs-lookup"><span data-stu-id="594f0-483">Open the contextual menu \(right-click\) > **Copy value**.</span></span>  <span data-ttu-id="594f0-484">Vous pouvez maintenant coller la valeur dans n’importe quel éditeur pour la réviser.</span><span class="sxs-lookup"><span data-stu-id="594f0-484">You may now paste the value into any editor to review it.</span></span>  
...
<span data-ttu-id="594f0-488">Par défaut, DevTools affiche le volet **Filtres.**</span><span class="sxs-lookup"><span data-stu-id="594f0-488">By default, DevTools show the **Filters** pane.</span></span>  
<span data-ttu-id="594f0-489">Choisissez **Filtre** \( ![ Filtre ](../media/filter-icon.msft.png) \) pour le masquer.</span><span class="sxs-lookup"><span data-stu-id="594f0-489">Choose **Filter** \(![Filter](../media/filter-icon.msft.png)\) to hide it.</span></span>  
...
:::image type="complex" source="../media/network-network-resources-hide-filters-button.msft.png" alt-text="Bouton Masquer les filtres" lightbox="../media/network-network-resources-hide-filters-button.msft.png":::
   <span data-ttu-id="594f0-491">Bouton Masquer les filtres</span><span class="sxs-lookup"><span data-stu-id="594f0-491">The Hide Filters button</span></span>  
:::image-end:::  

### <a name="use-large-request-rows"></a><span data-ttu-id="594f0-492">Utiliser des lignes de requête de grande taille</span><span class="sxs-lookup"><span data-stu-id="594f0-492">Use large request rows</span></span>  

<span data-ttu-id="594f0-493">Utilisez des lignes de grande taille lorsque vous souhaitez davantage d’espaces dans votre table de demandes réseau.</span><span class="sxs-lookup"><span data-stu-id="594f0-493">Use large rows when you want more whitespace in your network requests table.</span></span>  <span data-ttu-id="594f0-494">Certaines colonnes fournissent également un peu plus d’informations lors de l’utilisation de lignes de grande taille.</span><span class="sxs-lookup"><span data-stu-id="594f0-494">Some columns also provide a little more information when using large rows.</span></span>  <span data-ttu-id="594f0-495">Par exemple, la valeur inférieure de la colonne **Size** est la taille non compressée d’une demande.</span><span class="sxs-lookup"><span data-stu-id="594f0-495">For example, the bottom value of the **Size** column is the uncompressed size of a request.</span></span>  
...
:::image type="complex" source="../media/network-network-requests-large-request-rows.msft.png" alt-text="Exemple de lignes de requête importantes dans le volet Demandes" lightbox="../media/network-network-requests-large-request-rows.msft.png":::
   <span data-ttu-id="594f0-497">Exemple de lignes de requête importantes dans le **volet Demandes**</span><span class="sxs-lookup"><span data-stu-id="594f0-497">An example of large request rows in the **Requests** pane</span></span>  
:::image-end:::  

<span data-ttu-id="594f0-498">Pour activer les lignes de grande taille, activez la case à cocher Utiliser les **lignes de requête de** grande taille.</span><span class="sxs-lookup"><span data-stu-id="594f0-498">To enable large rows, turn on the **Use large request rows** checkbox.</span></span>  
...
:::image type="complex" source="../media/network-network-requests-use-large-request-rows-on.msft.png" alt-text="Case à cocher Utiliser les lignes de requête de grande taille" lightbox="../media/network-network-requests-use-large-request-rows-on.msft.png":::
   <span data-ttu-id="594f0-500">Case **à cocher Utiliser les lignes de requête de grande** taille</span><span class="sxs-lookup"><span data-stu-id="594f0-500">The **Use large request rows** checkbox</span></span>  
:::image-end:::  
...
## <a name="getting-in-touch-with-the-microsoft-edge-devtools-team"></a><span data-ttu-id="594f0-506">Contacter l’équipe DevTools MicrosoftEdge</span><span class="sxs-lookup"><span data-stu-id="594f0-506">Getting in touch with the Microsoft Edge DevTools team</span></span>  
