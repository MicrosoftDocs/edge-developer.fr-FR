...
[L’application Outils à distance Microsoft Edge \(Bêta\)][RemoteTools] est désormais disponible dans le [Microsoft Store][MicrosoftStore].  À l’aide de cette application, qui étend le portail d’appareil [Windows,][WindowsUwpDebugTestPerfDevicePortal]vous pouvez vous connecter à partir de l’instance de Microsoft Edge en cours d’exécution sur votre ordinateur de développement à un appareil Windows 10 distant, afficher une liste de cibles \(tous les onglets de Microsoft Edge et P [PWA][ProgressiveWebAppsChromiumIndex] s’ouvrent sur l’appareil Windows 10\) et utiliser de DevTools sur votre ordinateur de développement par rapport à une cible en cours d’exécution sur l’appareil Windows 10 distant.  
...
:::image type="complex" source="../../media/2020/03/settings.msft.png" alt-text="L’icône d’engrenage s Paramètres dans devTools" lightbox="../../media/2020/03/settings.msft.png":::
   L’icône **d’engrenage s Paramètres** dans devTools  
:::image-end:::  

Vous pouvez également ouvrir la Paramètres [à][DevtoolsCustomizeIndexSettings] partir du **menu principal** sous **Plus d’outils.**
...
Chromium problème [#1050855][CR1050855]
...
:::image type="complex" source="../../media/2020/03/properties-in-81.msft.png" alt-text="Dans Microsoft Edge 81 et antérieures, l’onglet Propriétés était vide après l’actualisation d’une page" lightbox="../../media/2020/03/properties-in-81.msft.png":::
   Dans Microsoft Edge 81 et antérieures, **l’onglet Propriétés** était vide après l’actualisation d’une page  
:::image-end:::  
...
Chromium problème [#1050999][CR1050999]  
...
Lorsque vous avez apporté une modification à un fichier minifié, l’outil **Changes** vous permet de faire défiler horizontalement pour afficher l’ensemble de votre code minifié.  À partir Microsoft Edge 83, vous pouvez maintenant faire défiler horizontalement à l’aide des touches de direction de votre clavier.  
...
Les sections suivantes annoncent des fonctionnalités supplémentaires disponibles dans Microsoft Edge 83 qui ont été contribués au projet d’Chromium open source.  

### <a name="emulate-vision-deficiencies"></a>Émuler les faiblesses de la vision  

Ouvrez [l’onglet][DevtoolsEvaluatePreformanceReferenceAnalyzeRenderingTool] Rendu et utilisez la nouvelle fonctionnalité Émuler les défauts de **vision** pour avoir une meilleure idée de la façon dont les personnes avec différents types de problèmes de vision rencontrent votre site.  
...
Chromium problème [#1003700][CR1003700]  
...
Chromium problème [#1051822][CR1051822]
...
La section **En-têtes de réponse** de l’onglet **En-têtes** fournit davantage d’instructions sur la façon de résoudre les problèmes :  
...
La motivation des nouvelles icônes était de rendre l’interface utilisateur plus cohérente avec les autres outils de débogage d’interface utilisateur graphique \(qui colorent généralement les points d’arrêt en rouge\) et de faciliter la distinction entre les 3 fonctionnalités en un coup d’œil.  
...
Chromium problème [#1011679][CR1011679]  
...
Chromium problème [#1016501][CR1016501]  
...
Chromium problème [#1054447][CR1054447]  
...
:::image type="complex" source="../../media/2020/03/maskable-icons.msft.png" alt-text="Afficher uniquement la zone sécurisée minimale pour la case à cocher des icônes masquées" lightbox="../../media/2020/03/maskable-icons.msft.png":::
   Case à cocher Afficher uniquement **la zone sécurisée minimale pour les icônes masquées**  
:::image-end:::  

> [!NOTE]
> Cette fonctionnalité a été lancée dans Microsoft Edge 81.  Les mises à jour couvertes ici Microsoft Edge 83 n’ont pas été couvertes dans [Nouveautés de DevTools (Microsoft Edge 81).][WhatsNew81]  
