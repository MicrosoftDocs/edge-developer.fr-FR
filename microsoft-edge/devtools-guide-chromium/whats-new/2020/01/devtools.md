...
Après [avoir activé la barre d'outils][DeviceToolbar]de l'appareil, simulez les dimensions d'uneport d'affichage g4 à partir de la liste **des** périphériques.  
...
#### <a name="copy-as-nodejs-fetch-to-include-cookie-data"></a>Copier en tant que Node.js pour inclure les données de cookie  
