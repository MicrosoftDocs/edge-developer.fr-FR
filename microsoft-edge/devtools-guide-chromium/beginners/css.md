...
<span data-ttu-id="3f16b-113">Votre site se présente actuellement comme suit:</span><span class="sxs-lookup"><span data-stu-id="3f16b-113">Currently your site looks like this:</span></span>  

> ##### <span data-ttu-id="3f16b-114">Figure1</span><span class="sxs-lookup"><span data-stu-id="3f16b-114">Figure 1</span></span>  
> <span data-ttu-id="3f16b-115">Aspect de votre site</span><span class="sxs-lookup"><span data-stu-id="3f16b-115">What your site currently looks like</span></span>  
> ![Aspect de votre site][ImageCssIntro1]  

<span data-ttu-id="3f16b-117">À la fin du didacticiel, il se présente comme suit:</span><span class="sxs-lookup"><span data-stu-id="3f16b-117">After completing the tutorial, it will look like this:</span></span>  

> ##### <span data-ttu-id="3f16b-118">Figure 2</span><span class="sxs-lookup"><span data-stu-id="3f16b-118">Figure 2</span></span>  
> <span data-ttu-id="3f16b-119">Aspect de votre site à la fin du didacticiel</span><span class="sxs-lookup"><span data-stu-id="3f16b-119">What your site will look like at the end of the tutorial</span></span>  
> ![Aspect de votre site à la fin du didacticiel][ImageCssIntro2]  

## <span data-ttu-id="3f16b-121">Définis</span><span class="sxs-lookup"><span data-stu-id="3f16b-121">Goals</span></span>   

<span data-ttu-id="3f16b-122">À la fin de ce didacticiel, vous allez comprendre les éléments suivants:</span><span class="sxs-lookup"><span data-stu-id="3f16b-122">By the end of this tutorial, you will understand:</span></span>  

*   <span data-ttu-id="3f16b-123">Comment utiliser les feuilles CSS pour appliquer un style à une page Web.</span><span class="sxs-lookup"><span data-stu-id="3f16b-123">How to use CSS to style a web page.</span></span>  
*   <span data-ttu-id="3f16b-124">Comment utiliser Microsoft Edge DevTools pour tester les feuilles CSS.</span><span class="sxs-lookup"><span data-stu-id="3f16b-124">How to use Microsoft Edge DevTools to experiment with CSS.</span></span>  
*   <span data-ttu-id="3f16b-125">Différence entre les infrastructures CSS et CSS.</span><span class="sxs-lookup"><span data-stu-id="3f16b-125">The difference between CSS and CSS frameworks.</span></span>  

<span data-ttu-id="3f16b-126">Vous disposez également d’un site Web réel.</span><span class="sxs-lookup"><span data-stu-id="3f16b-126">You'll also have a real website!</span></span>  

## <span data-ttu-id="3f16b-127">Conditions préalables</span><span class="sxs-lookup"><span data-stu-id="3f16b-127">Prerequisites</span></span>   

<span data-ttu-id="3f16b-128">Avant de suivre ce didacticiel, remplissez les conditions préalables suivantes:</span><span class="sxs-lookup"><span data-stu-id="3f16b-128">Before attempting this tutorial, complete the following prerequisites:</span></span>  

*   <span data-ttu-id="3f16b-129">Pour plus d’informations, [consultez prise en main de HTML et du DOM][DevToolsBeginnersHtml] ou assurez-vous que vous comprenez bien html et le DOM semblable à ce qui est enseigné dans ce didacticiel.</span><span class="sxs-lookup"><span data-stu-id="3f16b-129">Complete [Get Started with HTML and the DOM][DevToolsBeginnersHtml] or make sure that you have an understanding of HTML and the DOM similar to what's taught in that tutorial.</span></span>  
*   <span data-ttu-id="3f16b-130">Téléchargez le navigateur Web [Microsoft Edge][MicrosoftEdgeInsider] .</span><span class="sxs-lookup"><span data-stu-id="3f16b-130">Download the [Microsoft Edge][MicrosoftEdgeInsider] web browser.</span></span>  <span data-ttu-id="3f16b-131">Ce didacticiel utilise un ensemble d’outils de développement Web, appelés Microsoft Edge DevTools, qui sont intégrés à Microsoft Edge.</span><span class="sxs-lookup"><span data-stu-id="3f16b-131">This tutorial uses a set of web development tools, called the Microsoft Edge DevTools, that are built into Microsoft Edge.</span></span>  

## <span data-ttu-id="3f16b-132">Configurer votre code</span><span class="sxs-lookup"><span data-stu-id="3f16b-132">Set up your code</span></span>   

<span data-ttu-id="3f16b-133">Pour commencer à créer votre site, vous devez configurer votre code:</span><span class="sxs-lookup"><span data-stu-id="3f16b-133">In order to start creating your site, you need to set up your code:</span></span>  

1.  **<span data-ttu-id="3f16b-134">Si vous avez déjà effectué le premier didacticiel de cette série, ignorez cette section.</span><span class="sxs-lookup"><span data-stu-id="3f16b-134">If you have already completed the first tutorial in this series, skip this section!</span></span>  <span data-ttu-id="3f16b-135">Continuez à utiliser votre code à partir du dernier didacticiel, de [la mise en route de HTML et du DOM][DevToolsBeginnersHtml].</span><span class="sxs-lookup"><span data-stu-id="3f16b-135">Continue using your code from the last tutorial, [Get Started with HTML and the DOM][DevToolsBeginnersHtml].</span></span>**  
1.  <span data-ttu-id="3f16b-136">Ouvrez le [code source][GlitchCookedAmphibianIndex].</span><span class="sxs-lookup"><span data-stu-id="3f16b-136">Open the [source code][GlitchCookedAmphibianIndex].</span></span>  <span data-ttu-id="3f16b-137">Cet onglet de votre navigateur sera appelé **onglet édition**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-137">This tab of your browser will be called the **editing tab**.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-138">Figure3</span><span class="sxs-lookup"><span data-stu-id="3f16b-138">Figure 3</span></span>  
    > <span data-ttu-id="3f16b-139">Onglet édition</span><span class="sxs-lookup"><span data-stu-id="3f16b-139">The editing tab</span></span>  
    > ![Onglet édition][ImageCssSetup1]  
    
1.  <span data-ttu-id="3f16b-141">Cliquez sur **cuit-Amphibian**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-141">Click **cooked-amphibian**.</span></span>  <span data-ttu-id="3f16b-142">Un menu s’ouvre.</span><span class="sxs-lookup"><span data-stu-id="3f16b-142">A menu pops up.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-143">Figure 4</span><span class="sxs-lookup"><span data-stu-id="3f16b-143">Figure 4</span></span>  
    > <span data-ttu-id="3f16b-144">Menu options de Project</span><span class="sxs-lookup"><span data-stu-id="3f16b-144">The Project Options menu</span></span>  
    > ![Menu options de Project][ImageCssSetup2]  

1.  <span data-ttu-id="3f16b-146">Cliquez sur **Remix Project**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-146">Click **Remix Project**.</span></span>  <span data-ttu-id="3f16b-147">Le problème crée une copie du projet que vous pouvez modifier.</span><span class="sxs-lookup"><span data-stu-id="3f16b-147">Glitch creates a copy of the project that you can edit.</span></span>  
    
    > [!NOTE]
    > <span data-ttu-id="3f16b-148">Le problème génère un nom aléatoire pour le nouveau projet.</span><span class="sxs-lookup"><span data-stu-id="3f16b-148">Glitch generates a random name for the new project.</span></span>  
    
1.  <span data-ttu-id="3f16b-149">Cliquez sur **Afficher** et sélectionnez **dans une nouvelle fenêtre**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-149">Click **Show** and select **In a New Window**.</span></span>  <span data-ttu-id="3f16b-150">Un autre onglet s’ouvre en mode en direct de votre site.</span><span class="sxs-lookup"><span data-stu-id="3f16b-150">Another tab opens with a live view of your site.</span></span>  <span data-ttu-id="3f16b-151">L' **onglet Live**de votre navigateur s’appelle.</span><span class="sxs-lookup"><span data-stu-id="3f16b-151">This tab of your browser will be called the **live tab**.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-152">Figure 5</span><span class="sxs-lookup"><span data-stu-id="3f16b-152">Figure 5</span></span>  
...
1.  <span data-ttu-id="3f16b-168">Revenez à l’onglet modification et ouvrez `index.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-168">Go back to the editing tab and open `index.html`.</span></span>  
    ...
    > ##### <span data-ttu-id="3f16b-169">Figure 7</span><span class="sxs-lookup"><span data-stu-id="3f16b-169">Figure 7</span></span>  
    > `index.html`  
...
1.  <span data-ttu-id="3f16b-196">Revenir à l' **onglet Live**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-196">Go back to the **live tab**.</span></span>  
...
1.  <span data-ttu-id="3f16b-220">Après `li a` type `, h1` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-220">After `li a` type `, h1`.</span></span>  
    ...
    <span data-ttu-id="3f16b-221">Cela indique au navigateur d' `<h1>` avoir des éléments style de la même manière qu’il s’agit d’éléments qui correspondent au modèle `li a` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-221">This tells the browser to style `<h1>` elements the same way that it styles elements that match the pattern `li a`.</span></span>  
...
1.  <span data-ttu-id="3f16b-238">Cliquez avec le bouton droit sur le lien **Accueil** et sélectionnez **inspecter**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-238">Right-click the **Home** link and select **Inspect**.</span></span>  
    ...
    > ##### <span data-ttu-id="3f16b-239">Figure12</span><span class="sxs-lookup"><span data-stu-id="3f16b-239">Figure 12</span></span>  
    > <span data-ttu-id="3f16b-240">Examen du lien Accueil</span><span class="sxs-lookup"><span data-stu-id="3f16b-240">Inspecting the Home link</span></span>  
    > ![Examen du lien Accueil][ImageCssAdd1]  
    
    <span data-ttu-id="3f16b-242">DevTools s’ouvre à côté de votre page.</span><span class="sxs-lookup"><span data-stu-id="3f16b-242">DevTools opens up alongside your page.</span></span>  <span data-ttu-id="3f16b-243">Le code qui représente le lien Accueil `<a href="/">Home</a>` est surligné en bleu dans l’arborescence DOM.</span><span class="sxs-lookup"><span data-stu-id="3f16b-243">The code that represents the Home link, `<a href="/">Home</a>` is highlighted blue in the DOM Tree.</span></span>  <span data-ttu-id="3f16b-244">Pour cela, vous devez être familiarisé [avec la mise en route de HTML et du DOM][DevToolsBeginnersHtml].</span><span class="sxs-lookup"><span data-stu-id="3f16b-244">This should be familiar from [Get Started with HTML and the DOM][DevToolsBeginnersHtml].</span></span>  <span data-ttu-id="3f16b-245">Dans l’onglet **styles** sous l’arborescence DOM, vous pouvez voir la `font-family: 'Courier New', Courier, serif` déclaration que vous avez `contact.html` précédemment ajoutée.</span><span class="sxs-lookup"><span data-stu-id="3f16b-245">In the **Styles** tab below the DOM Tree you can see the `font-family: 'Courier New', Courier, serif` declaration that you added to `contact.html` earlier.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-246">Figure13</span><span class="sxs-lookup"><span data-stu-id="3f16b-246">Figure 13</span></span>  
    > <span data-ttu-id="3f16b-247">L’onglet styles se trouve sous l’arborescence DOM</span><span class="sxs-lookup"><span data-stu-id="3f16b-247">The Styles tab is below the DOM Tree</span></span>  
    > ![L’onglet styles se trouve sous l’arborescence DOM][ImageCssAdd2]  
    
    <span data-ttu-id="3f16b-249">Si votre fenêtre DevTools est large, l’onglet styles se trouve à droite de l’arborescence DOM.</span><span class="sxs-lookup"><span data-stu-id="3f16b-249">If your DevTools window is wide, the Styles tab is to the right of the DOM Tree.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-250">Figure14</span><span class="sxs-lookup"><span data-stu-id="3f16b-250">Figure 14</span></span>  
    > <span data-ttu-id="3f16b-251">Onglet styles à droite de l’arborescence DOM</span><span class="sxs-lookup"><span data-stu-id="3f16b-251">The Styles tab is to the right of the DOM Tree</span></span>  
    > ![Onglet styles à droite de l’arborescence DOM][ImageCssAdd3]  
    
1.  <span data-ttu-id="3f16b-253">Cliquez sur l’espace blanc ci-dessous `font-family: 'Courier New', Courier, Serif` pour ajouter une nouvelle déclaration.</span><span class="sxs-lookup"><span data-stu-id="3f16b-253">Click the whitespace below `font-family: 'Courier New', Courier, Serif` to add a new declaration.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-254">Figure15</span><span class="sxs-lookup"><span data-stu-id="3f16b-254">Figure 15</span></span>  
    > <span data-ttu-id="3f16b-255">Ajout d’une nouvelle déclaration</span><span class="sxs-lookup"><span data-stu-id="3f16b-255">Adding a new declaration</span></span>  
    > ![Ajout d’une nouvelle déclaration][ImageCssAdd4]  
    
1.  <span data-ttu-id="3f16b-257">Tapez `color` , puis appuyez sur `Enter` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-257">Type `color` and then press `Enter`.</span></span>  <span data-ttu-id="3f16b-258">L’interface utilisateur de saisie semi-automatique suggère des options au fur et à mesure que vous tapez.</span><span class="sxs-lookup"><span data-stu-id="3f16b-258">The autocomplete UI suggests options as you type.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-259">Figure16</span><span class="sxs-lookup"><span data-stu-id="3f16b-259">Figure 16</span></span>  
    > <span data-ttu-id="3f16b-260">Saisie</span><span class="sxs-lookup"><span data-stu-id="3f16b-260">Typing</span></span> `color`  
    > ![Entrer une couleur][ImageCssAdd5]  

1.  <span data-ttu-id="3f16b-262">Tapez `magenta` , puis appuyez de `Enter` nouveau.</span><span class="sxs-lookup"><span data-stu-id="3f16b-262">Type `magenta` and then press `Enter` again.</span></span>  <span data-ttu-id="3f16b-263">Tout le texte de la page de contact est désormais magenta.</span><span class="sxs-lookup"><span data-stu-id="3f16b-263">All of the text on the contact page is now magenta.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-264">Figure17</span><span class="sxs-lookup"><span data-stu-id="3f16b-264">Figure 17</span></span>  
    > <span data-ttu-id="3f16b-265">Saisie</span><span class="sxs-lookup"><span data-stu-id="3f16b-265">Typing</span></span> `magenta`  
    > ![Saisie de magenta][ImageCssAdd6]  
    
### <span data-ttu-id="3f16b-267">Modifier une déclaration dans DevTools</span><span class="sxs-lookup"><span data-stu-id="3f16b-267">Edit a declaration in DevTools</span></span>   

<span data-ttu-id="3f16b-268">Vous pouvez également modifier les déclarations existantes dans DevTools.</span><span class="sxs-lookup"><span data-stu-id="3f16b-268">You can also edit existing declarations in DevTools.</span></span>  <span data-ttu-id="3f16b-269">Essayez-le maintenant:</span><span class="sxs-lookup"><span data-stu-id="3f16b-269">Try it now:</span></span>  

1.  <span data-ttu-id="3f16b-270">Cliquez sur le carré magenta en regard de `magenta` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-270">Click the magenta square next to `magenta`.</span></span>  <span data-ttu-id="3f16b-271">Un sélecteur de couleur apparaît.</span><span class="sxs-lookup"><span data-stu-id="3f16b-271">A color picker pops up.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-272">Figure 18</span><span class="sxs-lookup"><span data-stu-id="3f16b-272">Figure 18</span></span>  
    > <span data-ttu-id="3f16b-273">Sélecteur de couleurs</span><span class="sxs-lookup"><span data-stu-id="3f16b-273">The Color Picker</span></span>  
    > ![Sélecteur de couleurs][ImageCssEdit1]  
    
1.  <span data-ttu-id="3f16b-275">Utilisez le sélecteur de couleurs pour remplacer le texte de la police par une couleur de votre choix.</span><span class="sxs-lookup"><span data-stu-id="3f16b-275">Use the color picker to change the font text to a color that you like.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-276">Figure 19</span><span class="sxs-lookup"><span data-stu-id="3f16b-276">Figure 19</span></span>  
    > <span data-ttu-id="3f16b-277">Modification de la couleur de police en violet grâce au sélecteur de couleurs</span><span class="sxs-lookup"><span data-stu-id="3f16b-277">Changing the font color to purple with the Color Picker</span></span>  
    > ![Modification de la couleur de police en violet grâce au sélecteur de couleurs][ImageCssEdit2]  

### <span data-ttu-id="3f16b-279">Ajouter un nouveau RuleSet dans DevTools</span><span class="sxs-lookup"><span data-stu-id="3f16b-279">Add a new ruleset in DevTools</span></span>   

<span data-ttu-id="3f16b-280">Vous pouvez également ajouter de nouvelles règles dans DevTools.</span><span class="sxs-lookup"><span data-stu-id="3f16b-280">You can also add new rulesets in DevTools.</span></span>  <span data-ttu-id="3f16b-281">Essayez-le maintenant:</span><span class="sxs-lookup"><span data-stu-id="3f16b-281">Try it now:</span></span>  

1.  <span data-ttu-id="3f16b-282">Cliquez sur **nouvelle règle** de style nouvelle règle de ![ style ][ImageNewStyleRuleIcon] en regard de **. CLS**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-282">Click **New Style Rule** ![New Style Rule][ImageNewStyleRuleIcon] which is next to **.cls**.</span></span>  <span data-ttu-id="3f16b-283">Un RuleSet vide apparaît avec `a` le sélecteur.</span><span class="sxs-lookup"><span data-stu-id="3f16b-283">An empty ruleset appears with `a` as the selector.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-284">Figure 20</span><span class="sxs-lookup"><span data-stu-id="3f16b-284">Figure 20</span></span>  
    > <span data-ttu-id="3f16b-285">Ajout d’une nouvelle règle</span><span class="sxs-lookup"><span data-stu-id="3f16b-285">Adding a new rule</span></span>  
    > ![Ajout d’une nouvelle règle][ImageCssRule1]  
    
1.  <span data-ttu-id="3f16b-287">Remplacer `a` par `a:hover` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-287">Replace `a` with `a:hover`.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-288">Figure 21</span><span class="sxs-lookup"><span data-stu-id="3f16b-288">Figure 21</span></span>  
    > <span data-ttu-id="3f16b-289">Remplacement `a` par</span><span class="sxs-lookup"><span data-stu-id="3f16b-289">Replacing `a` with</span></span> `a:hover`  
    > ![Remplacement de a avec a:hover][ImageCssRule2]  
    
    `:hover` <span data-ttu-id="3f16b-291">est une **Pseudo-classe**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-291">is a **pseudo-class**.</span></span>  <span data-ttu-id="3f16b-292">Utilisez des Pseudo-classes pour appliquer des styles aux éléments spécifiques.</span><span class="sxs-lookup"><span data-stu-id="3f16b-292">Use pseudo-classes to style elements when they enter special states.</span></span>  <span data-ttu-id="3f16b-293">Par exemple, le `a:hover` style n’est appliqué que lorsque vous pointez sur un `<a>` élément.</span><span class="sxs-lookup"><span data-stu-id="3f16b-293">For example, the `a:hover` style only takes effect when you're hovering over an `<a>` element.</span></span>  
    
1.  <span data-ttu-id="3f16b-294">Cliquez entre les crochets pour ajouter une nouvelle déclaration.</span><span class="sxs-lookup"><span data-stu-id="3f16b-294">Click between the brackets to add a new declaration.</span></span>  
1.  <span data-ttu-id="3f16b-295">Tapez `background-color` le nom de la déclaration et appuyez sur `Enter` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-295">Type `background-color` for the declaration name and then press `Enter`.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-296">Figure 22</span><span class="sxs-lookup"><span data-stu-id="3f16b-296">Figure 22</span></span>  
    > <span data-ttu-id="3f16b-297">Saisie</span><span class="sxs-lookup"><span data-stu-id="3f16b-297">Typing</span></span> `background-color`  
    > ![Saisie d’une couleur d’arrière-plan][ImageCssRule3]  
    
1.  <span data-ttu-id="3f16b-299">Tapez `green` la valeur de la déclaration, puis appuyez sur `Enter` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-299">Type `green` for the declaration value and then press `Enter`.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-300">Figure 23</span><span class="sxs-lookup"><span data-stu-id="3f16b-300">Figure 23</span></span>  
    > <span data-ttu-id="3f16b-301">Saisie</span><span class="sxs-lookup"><span data-stu-id="3f16b-301">Typing</span></span> `green`  
    > ![Saisie de texte vert][ImageCssRule4]  
    
1.  <span data-ttu-id="3f16b-303">Positionnez le pointeur de la souris sur le lien **Accueil** .</span><span class="sxs-lookup"><span data-stu-id="3f16b-303">Hover your mouse over the **Home** link.</span></span>  <span data-ttu-id="3f16b-304">L’arrière-plan du lien devient vert.</span><span class="sxs-lookup"><span data-stu-id="3f16b-304">The background of the link turns green.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-305">Figure 24</span><span class="sxs-lookup"><span data-stu-id="3f16b-305">Figure 24</span></span>  
    > <span data-ttu-id="3f16b-306">Survol du lien Accueil pour afficher son arrière-plan vert</span><span class="sxs-lookup"><span data-stu-id="3f16b-306">Hovering over the Home link to reveal its green background</span></span>  
    > ![Survol du lien Accueil pour afficher son arrière-plan vert][ImageCssRule5]  
    
## <span data-ttu-id="3f16b-308">Réutiliser les styles entre les pages à l’aide de feuilles de style externes</span><span class="sxs-lookup"><span data-stu-id="3f16b-308">Re-use styles across pages with external stylesheets</span></span>   
...
1.  <span data-ttu-id="3f16b-319">Revenez à l' **onglet Éditeur** , puis ouvrez `contact.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-319">Go back to the **editor tab** and open `contact.html`.</span></span>  
    ...
    > ##### <span data-ttu-id="3f16b-320">Figure 26</span><span class="sxs-lookup"><span data-stu-id="3f16b-320">Figure 26</span></span>  
    > `contact.html`  
    > ![contact.html][ImageCssExternal02]  
    
1.  <span data-ttu-id="3f16b-322">Supprimez tous `<style>` les éléments entre et `</style>` , y compris `<style>` et `</style>` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-322">Delete everything between `<style>` and `</style>`, including `<style>` and `</style>`.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-323">Figure 27</span><span class="sxs-lookup"><span data-stu-id="3f16b-323">Figure 27</span></span>  
    > <span data-ttu-id="3f16b-324">La balise de style a été supprimée</span><span class="sxs-lookup"><span data-stu-id="3f16b-324">The style tag has been removed</span></span>  
    > ![La balise de style a été supprimée][ImageCssExternal03]  
    
1.  <span data-ttu-id="3f16b-326">Accédez à `index.html` la balise et supprimez- `style="background-color: aliceblue;"` la `<nav>` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-326">Go to `index.html` and remove `style="background-color: aliceblue;"` from the `<nav>` tag.</span></span>  <span data-ttu-id="3f16b-327">Vous avez supprimé toutes les feuilles CSS que vous avez précédemment ajoutées à votre site.</span><span class="sxs-lookup"><span data-stu-id="3f16b-327">You have now removed all of the CSS that you previously added to your site.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-328">Figure 28</span><span class="sxs-lookup"><span data-stu-id="3f16b-328">Figure 28</span></span>  
    > <span data-ttu-id="3f16b-329">Le style intraligne a été supprimé de l’élément navigation</span><span class="sxs-lookup"><span data-stu-id="3f16b-329">The inline style has been removed from the nav element</span></span>  
    > ![Le style intraligne a été supprimé de l’élément navigation][ImageCssExternal04]  

1.  <span data-ttu-id="3f16b-331">Cliquez sur **nouveau fichier**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-331">Click **New File**.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-332">Figure 29</span><span class="sxs-lookup"><span data-stu-id="3f16b-332">Figure 29</span></span>  
    > <span data-ttu-id="3f16b-333">Boîte de dialogue nouveau fichier</span><span class="sxs-lookup"><span data-stu-id="3f16b-333">The new file dialog</span></span>  
    > ![Boîte de dialogue nouveau fichier][ImageCssExternal05]  
    
1.  <span data-ttu-id="3f16b-335">Remplacez `cool-file.js` par `style.css` , puis cliquez sur **Ajouter un fichier**.</span><span class="sxs-lookup"><span data-stu-id="3f16b-335">Replace `cool-file.js` with `style.css` and then click **Add File**.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-336">Figure 30</span><span class="sxs-lookup"><span data-stu-id="3f16b-336">Figure 30</span></span>  
    > <span data-ttu-id="3f16b-337">Saisie</span><span class="sxs-lookup"><span data-stu-id="3f16b-337">Typing</span></span> `style.css`  
    > ![Saisie de styles. CSS][ImageCssExternal06]  
    
1.  <span data-ttu-id="3f16b-339">Collez ce code dans les `style.css` éléments suivants:</span><span class="sxs-lookup"><span data-stu-id="3f16b-339">Paste this code into `style.css`:</span></span>  
    ...
    > ##### <span data-ttu-id="3f16b-340">Figure 31</span><span class="sxs-lookup"><span data-stu-id="3f16b-340">Figure 31</span></span>  
    > <span data-ttu-id="3f16b-341">Ajouter du code à</span><span class="sxs-lookup"><span data-stu-id="3f16b-341">Adding code to</span></span> `style.css`  
    > ![Ajouter du code à style. CSS][ImageCssExternal07]  
    
    <span data-ttu-id="3f16b-343">À ce stade, vous avez créé une feuille de style externe, mais votre code HTML ne sait pas encore qu’il existe.</span><span class="sxs-lookup"><span data-stu-id="3f16b-343">At this point, you have created an external stylesheet, but your HTML doesn't know that it exists, yet.</span></span>  
    
1.  <span data-ttu-id="3f16b-344">Ouvrir `index.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-344">Open `index.html`.</span></span>  
1.  <span data-ttu-id="3f16b-345">Ajoutez `<link rel="stylesheet" href="style.css">` à votre code html.</span><span class="sxs-lookup"><span data-stu-id="3f16b-345">Add `<link rel="stylesheet" href="style.css">` to your HTML.</span></span>  
    ...
    > ##### <span data-ttu-id="3f16b-346">Figure 32</span><span class="sxs-lookup"><span data-stu-id="3f16b-346">Figure 32</span></span>  
    > <span data-ttu-id="3f16b-347">Liaison à</span><span class="sxs-lookup"><span data-stu-id="3f16b-347">Linking to</span></span> `style.css`  
    > ![Liaison à style. CSS][ImageCssExternal08]  

1.  <span data-ttu-id="3f16b-349">Accédez à `contact.html` l’emplacement du lien et ajoutez-le.</span><span class="sxs-lookup"><span data-stu-id="3f16b-349">Go to `contact.html` and add the link there, too.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-350">Figure 33</span><span class="sxs-lookup"><span data-stu-id="3f16b-350">Figure 33</span></span>  
    > <span data-ttu-id="3f16b-351">Liaison vers `style.css` dans</span><span class="sxs-lookup"><span data-stu-id="3f16b-351">Linking to `style.css` in</span></span> `contact.html`  
    > ![Liaison vers style. CSS en contact.html][ImageCssExternal09]  

1.  <span data-ttu-id="3f16b-353">Accédez à l' **onglet Live**.  La page d’accueil possède désormais la même police que la dernière section et une section de navigation bleue.</span><span class="sxs-lookup"><span data-stu-id="3f16b-353">Go to the **live tab**.  The home page now has the same font from the last section and a blue navigation section.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-354">Figure 34</span><span class="sxs-lookup"><span data-stu-id="3f16b-354">Figure 34</span></span>  
    > <span data-ttu-id="3f16b-355">Page d’accueil</span><span class="sxs-lookup"><span data-stu-id="3f16b-355">The home page</span></span>  
    > ![Page d’accueil][ImageCssExternal10]  
    
1.  <span data-ttu-id="3f16b-357">Cliquez sur le lien de **contact** pour accéder à la page de contact.</span><span class="sxs-lookup"><span data-stu-id="3f16b-357">Click the **Contact** link to go to the contact page.</span></span>  <span data-ttu-id="3f16b-358">La page de contact a la même mise en forme que la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="3f16b-358">The contact page has the same formatting as the home page.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-359">Figure 35</span><span class="sxs-lookup"><span data-stu-id="3f16b-359">Figure 35</span></span>  
    > <span data-ttu-id="3f16b-360">Page de contact</span><span class="sxs-lookup"><span data-stu-id="3f16b-360">The contact page</span></span>  
    > ![Page de contact][ImageCssExternal11]  
    
## <span data-ttu-id="3f16b-362">Utiliser une infrastructure CSS</span><span class="sxs-lookup"><span data-stu-id="3f16b-362">Use a CSS framework</span></span>   

<span data-ttu-id="3f16b-363">Les **infrastructures CSS** sont des collections de styles intégrées par d’autres développeurs, qui simplifient la création de sites Web attractifs.</span><span class="sxs-lookup"><span data-stu-id="3f16b-363">**CSS frameworks** are collections of styles built by other developers that make it easier to create attractive web sites.</span></span>  <span data-ttu-id="3f16b-364">Au lieu de définir vous-même les styles, une infrastructure vous donne une collection de styles que vous pouvez utiliser sur les éléments de la page.</span><span class="sxs-lookup"><span data-stu-id="3f16b-364">Instead of defining styles yourself, a framework gives you a collection of styles that you can use on your page elements.</span></span>  

1.  <span data-ttu-id="3f16b-365">Copiez le code suivant:</span><span class="sxs-lookup"><span data-stu-id="3f16b-365">Copy the following code:</span></span>  
    
    ```html
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css">
    ```  
    
1.  <span data-ttu-id="3f16b-366">Accédez à l’onglet modification et collez le code dans `contact.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-366">Go to the editing tab and paste the code into `contact.html`.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-367">Figure 36</span><span class="sxs-lookup"><span data-stu-id="3f16b-367">Figure 36</span></span>  
    > <span data-ttu-id="3f16b-368">Liaison vers l’infrastructure dans</span><span class="sxs-lookup"><span data-stu-id="3f16b-368">Linking to the framework in</span></span> `contact.html`  
    > ![Liaison vers l’infrastructure dans contact.html][ImageCssFramework1]  
    
1.  <span data-ttu-id="3f16b-370">Collez également le code `index.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-370">Paste the code into `index.html`, as well.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-371">Figure 37</span><span class="sxs-lookup"><span data-stu-id="3f16b-371">Figure 37</span></span>  
    > <span data-ttu-id="3f16b-372">Liaison vers l’infrastructure dans</span><span class="sxs-lookup"><span data-stu-id="3f16b-372">Linking to the framework in</span></span> `index.html`  
    > ![Liaison vers l’infrastructure dans index.html][ImageCssFramework2]  
    
1.  <span data-ttu-id="3f16b-374">Revenez à l’onglet Live pour afficher vos modifications.</span><span class="sxs-lookup"><span data-stu-id="3f16b-374">Go back to the live tab to view your changes.</span></span>  <span data-ttu-id="3f16b-375">Même si la couleur d’arrière-plan de la `<nav>` police et la police des `li a` éléments sont identiques, la police des autres éléments a changé.</span><span class="sxs-lookup"><span data-stu-id="3f16b-375">While the background color of the `<nav>` and the font of the `li a` elements are the same, the font of the other elements has changed.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-376">Figure 38</span><span class="sxs-lookup"><span data-stu-id="3f16b-376">Figure 38</span></span>  
    > <span data-ttu-id="3f16b-377">Une partie de la police de la page d’accueil a changé en raison de l’infrastructure.</span><span class="sxs-lookup"><span data-stu-id="3f16b-377">Some of the font on the home page has changed because of the framework</span></span>  
    > ![Une partie de la police de la page d’accueil a changé en raison de l’infrastructure.][ImageCssFramework3]  

### <span data-ttu-id="3f16b-379">Utiliser une classe</span><span class="sxs-lookup"><span data-stu-id="3f16b-379">Use a class</span></span>   

<span data-ttu-id="3f16b-380">Dans la dernière section, vous avez ajouté des données d’amorçage dans vos pages Web, ce qui a modifié les polices de certains éléments de votre site.</span><span class="sxs-lookup"><span data-stu-id="3f16b-380">In the last section, you added Bootstrap to your web pages, which changed the fonts of some of the elements on your site.</span></span>  <span data-ttu-id="3f16b-381">Les infrastructures CSS vous permettent d’apporter des modifications importantes à votre page avec peu de code.</span><span class="sxs-lookup"><span data-stu-id="3f16b-381">CSS frameworks can help you make major changes to your page with very little code.</span></span>  <span data-ttu-id="3f16b-382">Essayez-le maintenant en modifiant votre en-tête:</span><span class="sxs-lookup"><span data-stu-id="3f16b-382">Try it now by changing your header:</span></span>  

1.  <span data-ttu-id="3f16b-383">Copiez ce code:</span><span class="sxs-lookup"><span data-stu-id="3f16b-383">Copy this code:</span></span>  
    
    ```html
    class="jumbotron jumbotron-fluid"  
    ```  
    
1.  <span data-ttu-id="3f16b-384">Ajoutez ce code à votre `<header>` balise dans `index.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-384">Add this code to your `<header>` tag in `index.html`.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-385">Figure 39</span><span class="sxs-lookup"><span data-stu-id="3f16b-385">Figure 39</span></span>  
    > <span data-ttu-id="3f16b-386">Ajouter des classes dans</span><span class="sxs-lookup"><span data-stu-id="3f16b-386">Adding classes in</span></span> `index.html`  
    > ![Ajouter des classes dans index.html][ImageCssJumbotron1]  
    
1.  <span data-ttu-id="3f16b-388">Ajoutez le code à votre `<header>` balise `contact.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-388">Add the code to your `<header>` tag in `contact.html`, too.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-389">Figure 40</span><span class="sxs-lookup"><span data-stu-id="3f16b-389">Figure 40</span></span>  
    > <span data-ttu-id="3f16b-390">Ajouter des classes dans</span><span class="sxs-lookup"><span data-stu-id="3f16b-390">Adding classes in</span></span> `contact.html`  
    > ![Ajouter des classes dans contact.html][ImageCssJumbotron2]  
    
1.  <span data-ttu-id="3f16b-392">Affichez vos modifications sous l’onglet Live.  Il y a une grande zone grise dans votre en-tête.</span><span class="sxs-lookup"><span data-stu-id="3f16b-392">View your changes in the live tab.  There's a big, grey box around your header now.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-393">Figure 41</span><span class="sxs-lookup"><span data-stu-id="3f16b-393">Figure 41</span></span>  
    > <span data-ttu-id="3f16b-394">L’en-tête est désormais entouré d’un cadre gris.</span><span class="sxs-lookup"><span data-stu-id="3f16b-394">The header now has a big, grey box around it</span></span>  
    > ![L’en-tête est désormais entouré d’un cadre gris.][ImageCssJumbotron3]  
    
### <span data-ttu-id="3f16b-396">Comprendre les classes</span><span class="sxs-lookup"><span data-stu-id="3f16b-396">Understand classes</span></span>   
...
<span data-ttu-id="3f16b-404">Le bootstrap fournit également des classes permettant d’aligner des éléments.</span><span class="sxs-lookup"><span data-stu-id="3f16b-404">Bootstrap also provides classes for aligning elements.</span></span>  <span data-ttu-id="3f16b-405">Essayez-le maintenant:</span><span class="sxs-lookup"><span data-stu-id="3f16b-405">Try it now:</span></span>  

1.  <span data-ttu-id="3f16b-406">Revenez à l’onglet Éditeur, puis ouvrez `index.html` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-406">Go back to the editor tab and open `index.html`.</span></span>  
1.  <span data-ttu-id="3f16b-407">Ajoutez `class="container-fluid"` à votre `<body>` indicateur.</span><span class="sxs-lookup"><span data-stu-id="3f16b-407">Add `class="container-fluid"` to your `<body>` tag.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-408">Figure 42</span><span class="sxs-lookup"><span data-stu-id="3f16b-408">Figure 42</span></span>  
    > <span data-ttu-id="3f16b-409">Ajout de la `container-fluid` classe</span><span class="sxs-lookup"><span data-stu-id="3f16b-409">Adding the `container-fluid` class</span></span>  
    > ![Ajout de la classe Container-fluidiques][ImageCssAlign1]  

1.  <span data-ttu-id="3f16b-411">Renvoyez `<nav>` vos `<main>` éléments et `<div class="row">` .</span><span class="sxs-lookup"><span data-stu-id="3f16b-411">Wrap your `<nav>` and `<main>` elements in `<div class="row">`.</span></span>  <span data-ttu-id="3f16b-412">Assurez-vous d’entrer `</div>` après pour `</main>` fermer correctement la nouvelle balise.</span><span class="sxs-lookup"><span data-stu-id="3f16b-412">Make sure to put `</div>` after `</main>` in order to properly close the new tag.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-413">Figure 43</span><span class="sxs-lookup"><span data-stu-id="3f16b-413">Figure 43</span></span>  
    > <span data-ttu-id="3f16b-414">Ajout d’une ligne</span><span class="sxs-lookup"><span data-stu-id="3f16b-414">Adding a row</span></span>  
    > ![Ajout d’une ligne][ImageCssAlign2]  
    
1.  <span data-ttu-id="3f16b-416">Ajoutez `class="col-3"` votre `<nav>` indicateur et `class="col-9"` votre `<main>` indicateur.</span><span class="sxs-lookup"><span data-stu-id="3f16b-416">Add `class="col-3"` to your `<nav>` tag and `class="col-9"` to your `<main>` tag.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-417">Figure 44</span><span class="sxs-lookup"><span data-stu-id="3f16b-417">Figure 44</span></span>  
    > <span data-ttu-id="3f16b-418">Ajout des `col-3` `col-9` classes et</span><span class="sxs-lookup"><span data-stu-id="3f16b-418">Adding the `col-3` and `col-9` classes</span></span>  
    > ![Ajout des classes col-3 et col-9][ImageCssAlign3]  
    
1.  <span data-ttu-id="3f16b-420">Affichez vos modifications sous l’onglet Live.</span><span class="sxs-lookup"><span data-stu-id="3f16b-420">View your changes in the live tab.</span></span>  
    
    > ##### <span data-ttu-id="3f16b-421">Figure 45</span><span class="sxs-lookup"><span data-stu-id="3f16b-421">Figure 45</span></span>  
    > <span data-ttu-id="3f16b-422">Le contenu de navigation est désormais à gauche du contenu principal</span><span class="sxs-lookup"><span data-stu-id="3f16b-422">The nav content is now to the left of the main content</span></span>  
    > ![Le contenu de navigation est désormais à gauche du contenu principal][ImageCssAlign4]  
    
## <span data-ttu-id="3f16b-424">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3f16b-424">Next steps</span></span>   

<span data-ttu-id="3f16b-425">Félicitations!</span><span class="sxs-lookup"><span data-stu-id="3f16b-425">Congratulations!</span></span>  <span data-ttu-id="3f16b-426">C’est terminé!</span><span class="sxs-lookup"><span data-stu-id="3f16b-426">You're done!</span></span>  
