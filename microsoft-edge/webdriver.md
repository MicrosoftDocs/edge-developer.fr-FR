...
| Accepter les certificats TLS non sécurisés | "acceptInsecureCerts"     | Non &nbsp; pris en charge       | N/A               |
| Stratégie de chargement de page               | "pageLoadStrategy"        | Pris en charge                | 17763             |
| Configuration du proxy              | doublure                   | Non &nbsp; pris en charge       | N/A               |
...
| POST        | ID/session/{session/Window/fullscreen                        | [Fenêtre plein écran](https://www.w3.org/TR/webdriver/#fullscreen-window)                   | Non &nbsp; pris en charge | N/A               |
...
| POST        | [/session/: sessionId/temporisation/async_script](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtimeoutsasync_script)               | Non &nbsp; pris en charge | N/A               |
...
| GET         | [/session/: sessionId/IME/available_engines](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeavailable_engines)               | Non &nbsp; pris en charge | N/A               |
| GET         | [/session/: sessionId/IME/active_engine](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeactive_engine)                       | Non &nbsp; pris en charge | N/A               |
| GET         | [/session/: sessionId/IME/activé](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeactivated)                               | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/IME/désactivé](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimedeactivate)                             | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/IME/activation](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeactivate)                                 | Non &nbsp; pris en charge | N/A               |
...
| GET         | [/session/: sessionId/élément/: ID](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidelementid)                                    | Non &nbsp; pris en charge | N/A               |
...
| GET         | [/session/: sessionId/orientation](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidorientation)                                  | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/orientation](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidorientation)                                  | Non &nbsp; pris en charge | N/A               |
...
| POST        | [/session/: sessionId/TouchWare/Click](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchclick)                                   | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/effleurement](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchdown)                                     | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/TouchWare/up](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchup)                                         | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/effleurement/déplacer](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchmove)                                     | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/effleurement/défilement](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchscroll)                                 | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/effleurement/défilement](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchscroll-1)                               | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/TouchWare/DoubleClick](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchdoubleclick)                       | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/TouchWare/longclick](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchlongclick)                           | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/tactile/raccourci](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchflick)                                   | Non &nbsp; pris en charge | N/A               |
| POST        | [/session/: sessionId/tactile/raccourci](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchflick-1)                                 | Non &nbsp; pris en charge | N/A               |
...
| GET         | [/session/: sessionId/log](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidlog)                                                  | Non &nbsp; pris en charge | N/A               |
| GET         | [/session/: sessionId/log/types](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidlogtypes)                                       | Non &nbsp; pris en charge | N/A               |
