...
*   <span data-ttu-id="fb7f4-121">Autorisez l’exécution du code JavaScript dans un WebView pour déclencher des événements personnalisés ([MSWebViewScriptNotify](#mswebviewscriptnotify)) dans votre application et permettre à votre application d’exécuter JavaScript dans le WebView ([invokeScriptAsync](#invokescriptasync)).</span><span class="sxs-lookup"><span data-stu-id="fb7f4-121">Allow JavaScript code running within a webview to raise custom events ([MSWebViewScriptNotify](#mswebviewscriptnotify)) to your app, and allow your app to run JavaScript within the webview ([invokeScriptAsync](#invokescriptasync)).</span></span>  
...
<span data-ttu-id="fb7f4-142">À partir de la [mise à jour 2018 de Windows 10 d’octobre](/windows/uwp/whats-new/windows-10-build-17763) (EdgeHTML 18), [les travailleurs de services sont pris en charge dans le contrôle WebView](/microsoft-edge/dev-guide#service-workers) (en plus du navigateur Microsoft Edge et des applications Windows 10 avec JavaScript).</span><span class="sxs-lookup"><span data-stu-id="fb7f4-142">Starting with the [Windows 10 October 2018 Update](/windows/uwp/whats-new/windows-10-build-17763) (EdgeHTML 18), [service workers are supported in the WebView control](/microsoft-edge/dev-guide#service-workers) (in addition to the Microsoft Edge browser and Windows 10 apps with JavaScript).</span></span>  
...
| <span data-ttu-id="fb7f4-167">Taille du volume</span><span class="sxs-lookup"><span data-stu-id="fb7f4-167">Volume size</span></span> |<span data-ttu-id="fb7f4-168">AppCache par domaine</span><span class="sxs-lookup"><span data-stu-id="fb7f4-168">AppCache per domain</span></span> | <span data-ttu-id="fb7f4-169">AppCache par utilisateur</span><span class="sxs-lookup"><span data-stu-id="fb7f4-169">AppCache per user</span></span> |  
|:--- |:--- |:--- |  
...
#### <span data-ttu-id="fb7f4-202">Informations sur l’événement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-202">Event Information</span></span>  
...
#### <span data-ttu-id="fb7f4-224">Informations sur l’événement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-224">Event Information</span></span>  
...
#### <span data-ttu-id="fb7f4-246">Informations sur l’événement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-246">Event Information</span></span>  
...
### <span data-ttu-id="fb7f4-322">MSWebViewNewWindowRequested</span><span class="sxs-lookup"><span data-stu-id="fb7f4-322">MSWebViewNewWindowRequested</span></span>  
...
#### <span data-ttu-id="fb7f4-339">Informations sur l’événement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-339">Event Information</span></span>  
...
### <span data-ttu-id="fb7f4-364">MSWebViewWebResourceRequested</span><span class="sxs-lookup"><span data-stu-id="fb7f4-364">MSWebViewWebResourceRequested</span></span>  
...
#### <span data-ttu-id="fb7f4-366">Informations sur l’événement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-366">Event Information</span></span>  
...
#### <span data-ttu-id="fb7f4-401">Informations sur l’événement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-401">Event Information</span></span>  
...
## <span data-ttu-id="fb7f4-422">Méthodes</span><span class="sxs-lookup"><span data-stu-id="fb7f4-422">Methods</span></span>  
...
<span data-ttu-id="fb7f4-441">Le paramètre Name doit être un nom de propriété JavaScript valide, sinon l’appel échoue en silence.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-441">The name parameter must be a valid JavaScript property name otherwise the call will fail silently.</span></span>  <span data-ttu-id="fb7f4-442">S’il s’agit d’une propriété qui existe déjà sur l’objet global, cette propriété est écrasée si la propriété est configurable.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-442">If the name is of a property that already exists on the global object then that property is overwritten if the property is configurable.</span></span>  <span data-ttu-id="fb7f4-443">Les propriétés non configurables sur l’objet global ne sont pas écrasées et l’appel addWebAllowedObject échoue en silence.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-443">Non-configurable properties on the global object are not overwritten and the addWebAllowedObject call fails silently.</span></span>  <span data-ttu-id="fb7f4-444">Les propriétés JavaScript créées via addWebAllowedObject sont modifiables, configurables et Enumerable.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-444">JavaScript properties created via addWebAllowedObject are writable, configurable, and enumerable.</span></span>  
...
#### <span data-ttu-id="fb7f4-445">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-445">Parameters</span></span>  

*<span data-ttu-id="fb7f4-446">name</span><span class="sxs-lookup"><span data-stu-id="fb7f4-446">name</span></span>*  

*   <span data-ttu-id="fb7f4-447">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-447">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-448">Nom de l’objet à exposer au document dans le **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-448">The name of the object to expose to the document in the **webview**.</span></span>  

*<span data-ttu-id="fb7f4-449">applicationObject</span><span class="sxs-lookup"><span data-stu-id="fb7f4-449">applicationObject</span></span>*  

*   <span data-ttu-id="fb7f4-450">Type: **objet**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-450">Type: **Object**</span></span>  
*   <span data-ttu-id="fb7f4-451">Objet à exposer dans le document dans le **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-451">The object to expose to the document in the **webview**.</span></span>  

#### <span data-ttu-id="fb7f4-452">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-452">Return value</span></span>  

<span data-ttu-id="fb7f4-453">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-453">This method does not return a value.</span></span>  

#### <span data-ttu-id="fb7f4-454">Fonctionnalités et exigences supplémentaires</span><span class="sxs-lookup"><span data-stu-id="fb7f4-454">Additional features and requirements</span></span>  

|  |  |  
|:--- |:--- |  
| **<span data-ttu-id="fb7f4-455">Client minimal pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-455">Minimum supported client</span></span>** | <span data-ttu-id="fb7f4-456">Windows 10 (applications du Windows Store uniquement)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-456">Windows10 (Windows Store apps only)</span></span> |    
| **<span data-ttu-id="fb7f4-457">Serveur minimal pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-457">Minimum supported server</span></span>** | <span data-ttu-id="fb7f4-458">Aucun pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-458">None supported</span></span> |   
| **<span data-ttu-id="fb7f4-459">Téléphone minimum pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-459">Minimum supported phone</span></span>** | <span data-ttu-id="fb7f4-460">Aucun pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-460">None supported</span></span> |  

### <span data-ttu-id="fb7f4-461">buildLocalStreamUri</span><span class="sxs-lookup"><span data-stu-id="fb7f4-461">buildLocalStreamUri</span></span>  

<span data-ttu-id="fb7f4-462">Crée un URI que vous pouvez transmettre à [navigateToLocalStreamUri](#methods).</span><span class="sxs-lookup"><span data-stu-id="fb7f4-462">Creates a URI that you can pass to [navigateToLocalStreamUri](#methods).</span></span>  

```javascript
var string = webview.buildLocalStreamUri(contentIdentifier, relativePath);
```  

#### <span data-ttu-id="fb7f4-463">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-463">Parameters</span></span>  

*<span data-ttu-id="fb7f4-464">contentIdentifier</span><span class="sxs-lookup"><span data-stu-id="fb7f4-464">contentIdentifier</span></span>*  

*   <span data-ttu-id="fb7f4-465">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-465">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-466">Identificateur unique pour le contenu référencé par l’URI.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-466">A unique identifier for the content the URI is referencing.</span></span>  <span data-ttu-id="fb7f4-467">Cela définit la racine de l’URI.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-467">This defines the root of the URI.</span></span>  

*<span data-ttu-id="fb7f4-468">Entraîne</span><span class="sxs-lookup"><span data-stu-id="fb7f4-468">relativePath</span></span>*  

*  <span data-ttu-id="fb7f4-469">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-469">Type: **String**</span></span>  
*  <span data-ttu-id="fb7f4-470">Le chemin d’accès à la ressource, par rapport à la racine.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-470">The path to the resource, relative to the root.</span></span>  

#### <span data-ttu-id="fb7f4-471">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-471">Return value</span></span>  

<span data-ttu-id="fb7f4-472">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-472">Type: **String**</span></span>  

<span data-ttu-id="fb7f4-473">URI créé en combinant et en normalisant *contentIdentifier* et *relativePath*.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-473">The URI created by combining and normalizing the *contentIdentifier* and *relativePath*.</span></span>  

#### <span data-ttu-id="fb7f4-474">Exemple</span><span class="sxs-lookup"><span data-stu-id="fb7f4-474">Example</span></span>  

<span data-ttu-id="fb7f4-475">L’exemple suivant illustre un cas d’utilisation classique.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-475">The following example illustrates a typical use case.</span></span>  
...
### <span data-ttu-id="fb7f4-476">capturePreviewToBlobAsync</span><span class="sxs-lookup"><span data-stu-id="fb7f4-476">capturePreviewToBlobAsync</span></span>  

<span data-ttu-id="fb7f4-477">Crée une image de l' [élément WebView](./webview.md) actuel et l’écrit dans l’élément image spécifié.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-477">Creates an image of the current [webview element](./webview.md) and write it to the specified image element.</span></span>  

```javascript
var capturePreviewToBlobAsync = webview.capturePreviewToBlobAsync();
```  

#### <span data-ttu-id="fb7f4-478">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-478">Parameters</span></span>  

<span data-ttu-id="fb7f4-479">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-479">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-480">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-480">Return value</span></span>  

<span data-ttu-id="fb7f4-481">Type: **MSWebViewAsyncOperation**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-481">Type: **MSWebViewAsyncOperation**</span></span>  

<span data-ttu-id="fb7f4-482">Un objet **MSWebViewAsyncOperation** qui, lorsqu’il se termine, fournit un objet **BLOB** contenant l’image.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-482">An **MSWebViewAsyncOperation** object that, when it completes, provides a **Blob** object that contains the image.</span></span>  <span data-ttu-id="fb7f4-483">Lorsque vous utilisez **capturePreviewToBlobAsync**, vous devez définir des gestionnaires de réussite et d’erreur après la définition de l’opération.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-483">When using **capturePreviewToBlobAsync**, you need to define success and error handlers after defining the operation.</span></span>  <span data-ttu-id="fb7f4-484">Après avoir appliqué les gestionnaires d’événements, appelez la méthode Start sur l’objet [MSWebViewAsyncOperation](./webview/MSWebViewAsyncOperation.md) pour exécuter l’opération.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-484">After applying the event handlers, call the start method on the [MSWebViewAsyncOperation](./webview/MSWebViewAsyncOperation.md) object to execute the operation.</span></span>  

### <span data-ttu-id="fb7f4-485">captureSelectedContentToDataPackageAsync</span><span class="sxs-lookup"><span data-stu-id="fb7f4-485">captureSelectedContentToDataPackageAsync</span></span>  

> [!IMPORTANT]
> <span data-ttu-id="fb7f4-486">Cette méthode a été déconseillée et présente un problème connu.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-486">This method has been deprecated and has a known issue.</span></span>  <span data-ttu-id="fb7f4-487">Évitez d’utiliser cette méthode dans votre code de production.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-487">Avoid using this method in your production code.</span></span>  

<span data-ttu-id="fb7f4-488">Obtient de manière asynchrone un [DataPackage](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.DataTransfer.DataPackage) qui contient le contenu sélectionné dans le **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-488">Asynchronously gets a [DataPackage](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.DataTransfer.DataPackage) that contains the selected content within the **webview**.</span></span>  

```javascript
var msWebViewAsyncOperation = webview.captureSelectedContentToDataPackageAsync();
```  

#### <span data-ttu-id="fb7f4-489">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-489">Parameters</span></span>  

<span data-ttu-id="fb7f4-490">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-490">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-491">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-491">Return value</span></span>  

<span data-ttu-id="fb7f4-492">Type: **MSWebViewAsyncOperation**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-492">Type: **MSWebViewAsyncOperation**</span></span>  

<span data-ttu-id="fb7f4-493">Un objet **MSWebViewAsyncOperation** qui, lorsqu’il se termine, fournit un objet [DataPackage](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.DataTransfer.DataPackage) contenant l’image.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-493">An **MSWebViewAsyncOperation** object that, when it completes, provides a [DataPackage](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.DataTransfer.DataPackage) object that contains the image.</span></span>  <span data-ttu-id="fb7f4-494">Lorsque vous utilisez **captureSelectedContentToDataPackageAsync**, vous devez définir des gestionnaires de réussite et d’erreur après la définition de l’opération.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-494">When using **captureSelectedContentToDataPackageAsync**, you need to define success and error handlers after defining the operation.</span></span>  <span data-ttu-id="fb7f4-495">Après avoir appliqué les gestionnaires d’événements, appelez la méthode Start sur l’objet MSWebViewAsyncOperation pour exécuter l’opération.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-495">After applying the event handlers, call the start method on the MSWebViewAsyncOperation object to execute the operation.</span></span>  
...
### <span data-ttu-id="fb7f4-496">invokeScriptAsync</span><span class="sxs-lookup"><span data-stu-id="fb7f4-496">invokeScriptAsync</span></span>  

<span data-ttu-id="fb7f4-497">En tant qu’action asynchrone, exécute la fonction de script spécifiée à partir du code HTML actuellement chargé, avec des arguments spécifiques.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-497">As an asynchronous action, executes the specified script function from the currently loaded HTML, with specific arguments.</span></span>  

```javascript
webview.invokeScriptAsync(functionName, ...args)
```  

#### <span data-ttu-id="fb7f4-498">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-498">Parameters</span></span>  

**<span data-ttu-id="fb7f4-499">Admises</span><span class="sxs-lookup"><span data-stu-id="fb7f4-499">functionName</span></span>**  

*   <span data-ttu-id="fb7f4-500">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-500">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-501">Nom de la fonction à appeler.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-501">The name of the function to invoke.</span></span>  <span data-ttu-id="fb7f4-502">Il s’agit d’un nom de propriété dans l’objet fenêtre globale du document de niveau supérieur de l’affichage.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-502">This is a property name on the global window object of the WebView's top level document.</span></span>  <span data-ttu-id="fb7f4-503">Il peut s’agir d’une fonction globale intégrée telle que Eval ou Open, ou d’une fonction définie par script sur l’objet Window global.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-503">This can be a built-in global function like eval or open, or it can be a script defined function on the global window object.</span></span>  <span data-ttu-id="fb7f4-504">Seules les fonctions figurant dans le document de niveau supérieur de l’affichage WebView sont parfois appelées.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-504">Only functions in the top level document of the WebView may be invoked.</span></span>  

**<span data-ttu-id="fb7f4-505">args</span><span class="sxs-lookup"><span data-stu-id="fb7f4-505">args</span></span>**  

*   <span data-ttu-id="fb7f4-506">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-506">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-507">Paramètres de chaîne facultatifs à passer à la fonction appelée.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-507">Optional string parameters to pass to the invoked function.</span></span>  <span data-ttu-id="fb7f4-508">À l’issue de nomfonction, tout paramètre supplémentaire à invokeScriptAsync est une chaîne transmise à la fonction appelée.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-508">After functionName, any additional parameters to invokeScriptAsync are strings passed to the invoked function.</span></span>  

#### <span data-ttu-id="fb7f4-509">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-509">Return value</span></span>  

<span data-ttu-id="fb7f4-510">Type: **MSWebViewAsyncOperation**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-510">Type: **MSWebViewAsyncOperation**</span></span>  

<span data-ttu-id="fb7f4-511">Lorsque vous utilisez **invokeScriptAsync**, vous devez définir des gestionnaires de réussite et d’erreur après la définition de l’opération.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-511">When using **invokeScriptAsync**, you need to define success and error handlers after defining the operation.</span></span>  <span data-ttu-id="fb7f4-512">Après avoir appliqué les gestionnaires d’événements, appelez **MSWebViewAsyncOperation. Start** pour exécuter l’opération.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-512">After applying the event handlers, call **MSWebViewAsyncOperation.start** to execute the operation.</span></span>  <span data-ttu-id="fb7f4-513">Si l’événement complet de MSWebViewAsyncOperation se déclenche, la propriété Result de MSWebViewAsyncOperation est la valeur de retour de chaîne de l’appel de la fonction.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-513">If the MSWebViewAsyncOperation's complete event fires then the MSWebViewAsyncOperation's result property is the string return value from invoking the function.</span></span>  <span data-ttu-id="fb7f4-514">L’utilisation de la valeur de retour de la fonction invoked permet à la communication par le biais du WebView de se reconnecter à l’hôte WebView de manière synchrone.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-514">Using the invoked function's return value allows for the WebView content to communication synchronously back to the WebView host.</span></span>  <span data-ttu-id="fb7f4-515">Pour que le contenu WebView communique de manière asynchrone à l’hôte WebView, voir l’événement MSWebViewScriptNotify.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-515">To instead have the WebView content communicate asynchronously back to the WebView host see the MSWebViewScriptNotify event.</span></span>  <span data-ttu-id="fb7f4-516">Si la fonction appelée lève une exception non gérée, l’événement d’erreur de MSWebViewAsyncOperation se déclenche.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-516">If the function invoked throws an unhandled exception then the MSWebViewAsyncOperation's error event will fire.</span></span>  
...
### <span data-ttu-id="fb7f4-517">getDeferredPermissionRequests</span><span class="sxs-lookup"><span data-stu-id="fb7f4-517">getDeferredPermissionRequests</span></span>  

<span data-ttu-id="fb7f4-518">Renvoie une liste de demandes d’autorisation différées émises par le contenu du contrôle **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-518">Returns a list of deferred permission requests issued by content in the **webview** control.</span></span>  

```javascript
var sequence<PermissionRequest> = x-ms-webview.getDeferredPermissionRequests();
```  

#### <span data-ttu-id="fb7f4-519">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-519">Parameters</span></span>  

<span data-ttu-id="fb7f4-520">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-520">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-521">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-521">Return value</span></span>  

<span data-ttu-id="fb7f4-522">Type: [DeferredPermissionRequest](./webview/DeferredPermissionRequest.md)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-522">Type: [DeferredPermissionRequest](./webview/DeferredPermissionRequest.md)</span></span>  

<span data-ttu-id="fb7f4-523">Demande d’autorisation différée spécifiée.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-523">The specified deferred permission request.</span></span>  

#### <span data-ttu-id="fb7f4-524">Fonctionnalités et exigences supplémentaires</span><span class="sxs-lookup"><span data-stu-id="fb7f4-524">Additional features and requirements</span></span>  

|  | |  
|:--- |:--- |  
| **<span data-ttu-id="fb7f4-525">Client minimal pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-525">Minimum supported client</span></span>** | <span data-ttu-id="fb7f4-526">Windows 10 (applications du Windows Store uniquement)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-526">Windows10 (Windows Store apps only)</span></span> |  
| **<span data-ttu-id="fb7f4-527">Serveur minimal pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-527">Minimum supported server</span></span>** | <span data-ttu-id="fb7f4-528">Aucun pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-528">None supported</span></span> |  
| **<span data-ttu-id="fb7f4-529">Téléphone minimum pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-529">Minimum supported phone</span></span>** | <span data-ttu-id="fb7f4-530">Aucun pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-530">None supported</span></span> |  


### <span data-ttu-id="fb7f4-531">getDeferredPermissionRequestById</span><span class="sxs-lookup"><span data-stu-id="fb7f4-531">getDeferredPermissionRequestById</span></span>  

<span data-ttu-id="fb7f4-532">Renvoie la demande d’autorisation différée spécifiée.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-532">Returns the specified deferred permission request.</span></span>  

```javascript
var deferredPermissionRequest = x-ms-webview.getDeferredPermissionRequestById(id);
```  

#### <span data-ttu-id="fb7f4-533">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-533">Parameters</span></span>  

*<span data-ttu-id="fb7f4-534">id</span><span class="sxs-lookup"><span data-stu-id="fb7f4-534">id</span></span>*  

*   <span data-ttu-id="fb7f4-535">Type: **longue non signée**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-535">Type: **unsigned long**</span></span>  
*   <span data-ttu-id="fb7f4-536">ID de la demande d’autorisation différée que vous souhaitez obtenir.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-536">The ID of the deferred permission request you wish to get.</span></span>  

#### <span data-ttu-id="fb7f4-537">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-537">Return value</span></span>  

<span data-ttu-id="fb7f4-538">Type: [DeferredPermissionRequest](./webview/DeferredPermissionRequest.md)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-538">Type: [DeferredPermissionRequest](./webview/DeferredPermissionRequest.md)</span></span>  

<span data-ttu-id="fb7f4-539">Demande d’autorisation différée spécifiée.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-539">The specified deferred permission request.</span></span>  

#### <span data-ttu-id="fb7f4-540">Fonctionnalités et exigences supplémentaires</span><span class="sxs-lookup"><span data-stu-id="fb7f4-540">Additional features and requirements</span></span>  

|  |  |  
|:--- |:--- |  
| **<span data-ttu-id="fb7f4-541">Client minimal pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-541">Minimum supported client</span></span>** | <span data-ttu-id="fb7f4-542">Windows 10 (applications du Windows Store uniquement)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-542">Windows10 (Windows Store apps only)</span></span> |  
| **<span data-ttu-id="fb7f4-543">Serveur minimal pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-543">Minimum supported server</span></span>** | <span data-ttu-id="fb7f4-544">Aucun pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-544">None supported</span></span> |  
| **<span data-ttu-id="fb7f4-545">Téléphone minimum pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-545">Minimum supported phone</span></span>** | <span data-ttu-id="fb7f4-546">Aucun pris en charge</span><span class="sxs-lookup"><span data-stu-id="fb7f4-546">None supported</span></span> |  

### <span data-ttu-id="fb7f4-547">goBack</span><span class="sxs-lookup"><span data-stu-id="fb7f4-547">goBack</span></span>  

<span data-ttu-id="fb7f4-548">Permet d’accéder à la page précédente de l’historique de navigation via le **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-548">Navigates the **webview** to the previous page in the navigation history.</span></span>  

```javascript
webview.goBack();
```  

#### <span data-ttu-id="fb7f4-549">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-549">Parameters</span></span>  

<span data-ttu-id="fb7f4-550">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-550">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-551">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-551">Return value</span></span>  

<span data-ttu-id="fb7f4-552">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-552">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-553">goForward</span><span class="sxs-lookup"><span data-stu-id="fb7f4-553">goForward</span></span>  

<span data-ttu-id="fb7f4-554">Navigue vers la page suivante de l’historique de navigation du **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-554">Navigates the **webview** to the next page in the navigation history.</span></span>  

```javascript
webview.goForward();
```  

#### <span data-ttu-id="fb7f4-555">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-555">Parameters</span></span>  

<span data-ttu-id="fb7f4-556">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-556">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-557">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-557">Return value</span></span>  

<span data-ttu-id="fb7f4-558">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-558">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-559">naviguer</span><span class="sxs-lookup"><span data-stu-id="fb7f4-559">navigate</span></span>  

<span data-ttu-id="fb7f4-560">Charge le contenu HTML à l’URI (Uniform Resource Identifier) spécifié.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-560">Loads the HTML content at the specified Uniform Resource Identifier (URI).</span></span>  

```javascript
webview.navigate(uri);
```  

#### <span data-ttu-id="fb7f4-561">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-561">Parameters</span></span>  

**<span data-ttu-id="fb7f4-562">uri</span><span class="sxs-lookup"><span data-stu-id="fb7f4-562">uri</span></span>**  

*   <span data-ttu-id="fb7f4-563">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-563">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-564">URI à charger.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-564">The URI to load.</span></span>  

#### <span data-ttu-id="fb7f4-565">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-565">Return value</span></span>  

<span data-ttu-id="fb7f4-566">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-566">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-567">navigateFocus</span><span class="sxs-lookup"><span data-stu-id="fb7f4-567">navigateFocus</span></span>  

<span data-ttu-id="fb7f4-568">Déplace le focus sur le **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-568">Navigates focus onto the **webview**.</span></span>  <span data-ttu-id="fb7f4-569">Déclenche l’événement navigatingfocus window’s du document de niveau supérieur de l’affichage.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-569">Fires the webview's top level document's window's navigatingfocus event.</span></span>  <span data-ttu-id="fb7f4-570">Les arguments FocusNavigationEvent utilisés dans l’événement navigatingfocus correspondent aux paramètres fournis à navigateFocus, sauf que les paramètres d’origine sont convertis à partir de l’espace de coordonnées du document hôte vers l’espace de coordonnées du document de niveau supérieur de la WebView.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-570">The FocusNavigationEvent args used in the navigatingfocus event match the parameters provided to navigateFocus except the origin parameters are translated from the host document's coordinate space to the coordinate space of the webview's top level document.</span></span>  <span data-ttu-id="fb7f4-571">Voir l’événement WebView departingFocus et la méthode Window. departFocus correspondante pour transférer le focus du WebView vers l’hôte.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-571">See the webview departingFocus event and corresponding window.departFocus method for transferring focus from the webview to the host.</span></span>  <span data-ttu-id="fb7f4-572">Pour obtenir un exemple d’implémentation de la navigation au focus par le biais d’un clavier ou d’un boîtier de empilement qui utilise cette méthode, voir la [bibliothèque de navigation par TVJS](https://github.com/Microsoft/TVHelpers/wiki/Using-DirectionalNavigation) .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-572">See the [TVJS's Direction Navigation library](https://github.com/Microsoft/TVHelpers/wiki/Using-DirectionalNavigation) for an example of an implementation of focus navigation via keyboard or gamepad that uses this method.</span></span>  
...
#### <span data-ttu-id="fb7f4-573">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-573">Parameters</span></span>  

*<span data-ttu-id="fb7f4-574">navigationReason</span><span class="sxs-lookup"><span data-stu-id="fb7f4-574">navigationReason</span></span>*  

*   <span data-ttu-id="fb7f4-575">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-575">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-576">Raison de la navigation.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-576">The reason for the navigation.</span></span>  <span data-ttu-id="fb7f4-577">La valeur doit être «gauche», «haut», «droite» ou «bas».</span><span class="sxs-lookup"><span data-stu-id="fb7f4-577">The value should be either "left", "up", "right", or "down".</span></span>  <span data-ttu-id="fb7f4-578">C’est la direction dans laquelle le focus quitte l’élément actuellement sélectionné.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-578">It is the direction in which focus is moving away from the currently focused element.</span></span>  

*<span data-ttu-id="fb7f4-579">prêts</span><span class="sxs-lookup"><span data-stu-id="fb7f4-579">origin</span></span>*  

*   <span data-ttu-id="fb7f4-580">Type: **objet**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-580">Type: **Object**</span></span>  
*   <span data-ttu-id="fb7f4-581">Origine de la navigation.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-581">The origin of the navigation.</span></span>  <span data-ttu-id="fb7f4-582">Il s’agit d’un objet JavaScript avec les propriétés «originLeft», «originTop», «originWidth» et «originHeight».</span><span class="sxs-lookup"><span data-stu-id="fb7f4-582">This is a JavaScript object with properties "originLeft", "originTop", "originWidth", and "originHeight".</span></span>  <span data-ttu-id="fb7f4-583">Ces valeurs doivent décrire la position et la taille de l’élément actuellement sélectionné hors du mouvement.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-583">These values should describe the position and size of the currently focused element away from which focus is moving.</span></span>  

#### <span data-ttu-id="fb7f4-584">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-584">Return value</span></span>  

<span data-ttu-id="fb7f4-585">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-585">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-586">navigateToLocalStreamUri</span><span class="sxs-lookup"><span data-stu-id="fb7f4-586">navigateToLocalStreamUri</span></span>  

<span data-ttu-id="fb7f4-587">Charge le contenu Web local à l’URI spécifié à l’aide d’un [**UriToStreamResolver**](/uwp/api/windows.web.iuritostreamresolver.uritostreamasync).</span><span class="sxs-lookup"><span data-stu-id="fb7f4-587">Loads local web content at the specified URI using a [**UriToStreamResolver**](/uwp/api/windows.web.iuritostreamresolver.uritostreamasync).</span></span>  

```javascript
webview.navigateToLocalStreamUri(source, streamResolver); 
```  

#### <span data-ttu-id="fb7f4-588">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-588">Parameters</span></span>  

*<span data-ttu-id="fb7f4-589">origine</span><span class="sxs-lookup"><span data-stu-id="fb7f4-589">source</span></span>*  

*   <span data-ttu-id="fb7f4-590">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-590">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-591">URI MS-local-Stream qui identifie le contenu HTML local à charger.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-591">An ms-local-stream URI identifying the local HTML content to load.</span></span>  <span data-ttu-id="fb7f4-592">Créez cette chaîne à l’aide de [**buildLocalStreamUri**](/uwp/api/windows.web.ui.iwebviewcontrol.buildlocalstreamuri).</span><span class="sxs-lookup"><span data-stu-id="fb7f4-592">Create this string using [**buildLocalStreamUri**](/uwp/api/windows.web.ui.iwebviewcontrol.buildlocalstreamuri).</span></span>  

*<span data-ttu-id="fb7f4-593">streamResolver</span><span class="sxs-lookup"><span data-stu-id="fb7f4-593">streamResolver</span></span>*  

*   <span data-ttu-id="fb7f4-594">Tapez: tout</span><span class="sxs-lookup"><span data-stu-id="fb7f4-594">Type: any</span></span>  
*   <span data-ttu-id="fb7f4-595">Un résolveur qui convertit l’URI en flux à charger.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-595">A resolver that converts the URI into a stream to load.</span></span>  

#### <span data-ttu-id="fb7f4-596">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-596">Return value</span></span>  

<span data-ttu-id="fb7f4-597">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-597">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-598">navigateToString</span><span class="sxs-lookup"><span data-stu-id="fb7f4-598">navigateToString</span></span>  

<span data-ttu-id="fb7f4-599">Charge le contenu HTML spécifié sous la forme d’un nouveau document.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-599">Loads the specified HTML content as a new document.</span></span>  

```javascript
webview.navigateToString(contents);
```  

#### <span data-ttu-id="fb7f4-600">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-600">Parameters</span></span>  

*<span data-ttu-id="fb7f4-601">teneur</span><span class="sxs-lookup"><span data-stu-id="fb7f4-601">contents</span></span>*  

*   <span data-ttu-id="fb7f4-602">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-602">Type: **String**</span></span>  
*   <span data-ttu-id="fb7f4-603">Contenu HTML à afficher.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-603">The HTML content to display.</span></span>  

#### <span data-ttu-id="fb7f4-604">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-604">Return value</span></span>  

<span data-ttu-id="fb7f4-605">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-605">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-606">navigateWithHttpRequestMessage</span><span class="sxs-lookup"><span data-stu-id="fb7f4-606">navigateWithHttpRequestMessage</span></span>  

<span data-ttu-id="fb7f4-607">Accède au WebView à un URI (Uniform Resource Identifier) avec un en-tête de requête POST et des en-têtes HTTP.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-607">Navigates the webview to a Uniform Resource Identifier (URI) with a POST request and HTTP headers.</span></span>  

```javascript
webview.navigateWithHttpRequestMessage(requestMessage);
```  

#### <span data-ttu-id="fb7f4-608">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-608">Parameters</span></span>  

*<span data-ttu-id="fb7f4-609">Collection RequestMessage</span><span class="sxs-lookup"><span data-stu-id="fb7f4-609">requestMessage</span></span>*  

*   <span data-ttu-id="fb7f4-610">Type: **HttpRequestMessage**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-610">Type: **HttpRequestMessage**</span></span>  
*   <span data-ttu-id="fb7f4-611">Détails de la requête HTTP.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-611">The details of the HTTP request.</span></span>  

#### <span data-ttu-id="fb7f4-612">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-612">Return value</span></span>  

<span data-ttu-id="fb7f4-613">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-613">This method does not return a value.</span></span>  

#### <span data-ttu-id="fb7f4-614">Remarques</span><span class="sxs-lookup"><span data-stu-id="fb7f4-614">Remarks</span></span>  

> [!WARNING]
> <span data-ttu-id="fb7f4-615">Si vous ajoutez des en-têtes supplémentaires à cette requête, tels que les informations d’identification d’authentification, n’oubliez pas que ces en-têtes seront également inclus dans toutes les demandes enfant ultérieures.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-615">If you add additional headers to this request, such as authentication credentials, remember that those headers will also be included with any subsequent child requests.</span></span>  <span data-ttu-id="fb7f4-616">Faites preuve de prudence pour éviter toute divulgation accidentelle de renseignements confidentiels ou personnels.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-616">Use caution to prevent accidental disclosure of confidential or personal information.</span></span>  

### <span data-ttu-id="fb7f4-617">mise</span><span class="sxs-lookup"><span data-stu-id="fb7f4-617">refresh</span></span>  

<span data-ttu-id="fb7f4-618">Recharge le contenu actuel dans **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-618">Reloads the current content in the **webview**.</span></span>  

```javascript
webview.refresh();
```  

#### <span data-ttu-id="fb7f4-619">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-619">Parameters</span></span>  

<span data-ttu-id="fb7f4-620">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-620">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-621">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-621">Return value</span></span>  

<span data-ttu-id="fb7f4-622">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-622">This method does not return a value.</span></span>  

### <span data-ttu-id="fb7f4-623">stop</span><span class="sxs-lookup"><span data-stu-id="fb7f4-623">stop</span></span>  

<span data-ttu-id="fb7f4-624">Arrête la navigation ou le téléchargement de l' **affichage WebView** actuel.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-624">Halts the current **webview** navigation or download.</span></span>  

```javascript
webview.stop();
```  

#### <span data-ttu-id="fb7f4-625">Parameters</span><span class="sxs-lookup"><span data-stu-id="fb7f4-625">Parameters</span></span>  

<span data-ttu-id="fb7f4-626">Cette méthode n’a aucun paramètre.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-626">This method has no parameters.</span></span>  

#### <span data-ttu-id="fb7f4-627">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="fb7f4-627">Return value</span></span>  

<span data-ttu-id="fb7f4-628">Cette méthode ne renvoie pas de valeur.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-628">This method does not return a value.</span></span>  

## <span data-ttu-id="fb7f4-629">Propriétés</span><span class="sxs-lookup"><span data-stu-id="fb7f4-629">Properties</span></span>  

### <span data-ttu-id="fb7f4-630">canGoBack</span><span class="sxs-lookup"><span data-stu-id="fb7f4-630">canGoBack</span></span>  

<span data-ttu-id="fb7f4-631">Obtient une valeur qui indique si le **WebView** peut naviguer vers l’arrière.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-631">Gets a value that indicates whether the **webview** can navigate backward.</span></span>  

<span data-ttu-id="fb7f4-632">Cette propriété est en lecture seule.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-632">This property is read-only.</span></span>  

```javascript
var canGoBack = webview.canGoBack;
```  

#### <span data-ttu-id="fb7f4-633">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-633">Property value</span></span>  

<span data-ttu-id="fb7f4-634">Type: **booléen**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-634">Type: **Boolean**</span></span>  

<span data-ttu-id="fb7f4-635">**True** si **WebView** peut naviguer vers l’arrière; Sinon, **false**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-635">**True** if the **webview** can navigate backward; otherwise, **false**.</span></span>  

### <span data-ttu-id="fb7f4-636">canGoForward</span><span class="sxs-lookup"><span data-stu-id="fb7f4-636">canGoForward</span></span>  

<span data-ttu-id="fb7f4-637">Obtient une valeur qui indique s’il est possible d’accéder à **WebView** en aval.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-637">Gets a value that indicates whether the **webview** can navigate forward.</span></span>  

<span data-ttu-id="fb7f4-638">Cette propriété est en lecture seule.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-638">This property is read-only.</span></span>  

```javascript
var canGoForward = webview.canGoForward;
```  

#### <span data-ttu-id="fb7f4-639">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-639">Property value</span></span>  

<span data-ttu-id="fb7f4-640">Type: **booléen**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-640">Type: **Boolean**</span></span>  

<span data-ttu-id="fb7f4-641">**True** si **WebView** peut naviguer vers l’avant; Sinon, **false**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-641">**True** if the **webview** can navigate forward; otherwise, **false**.</span></span>  

### <span data-ttu-id="fb7f4-642">containsFullScreenElement</span><span class="sxs-lookup"><span data-stu-id="fb7f4-642">containsFullScreenElement</span></span>  

<span data-ttu-id="fb7f4-643">Obtient une valeur qui indique si le **WebView** contient un élément qui prend en charge le plein écran.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-643">Gets a value that indicates whether the **webview** contains an element that supports full screen.</span></span>  <span data-ttu-id="fb7f4-644">Pour plus d’informations, voir l’événement MSWebViewContainsFullScreenElementChanged.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-644">See the MSWebViewContainsFullScreenElementChanged event for more info.</span></span>  

<span data-ttu-id="fb7f4-645">Cette propriété est en lecture seule.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-645">This property is read-only.</span></span>  

```javascript
var containsFullScreenElement = webview.containsFullScreenElement;
```  

#### <span data-ttu-id="fb7f4-646">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-646">Property value</span></span>  

<span data-ttu-id="fb7f4-647">Type: **booléen**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-647">Type: **Boolean**</span></span>  

<span data-ttu-id="fb7f4-648">**True** si **WebView** contient un élément qui prend en charge le plein écran; Sinon, **false**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-648">**True** if the **webview** contains an element that supports full screen; otherwise, **false**.</span></span>  

### <span data-ttu-id="fb7f4-649">documentTitle</span><span class="sxs-lookup"><span data-stu-id="fb7f4-649">documentTitle</span></span>  

<span data-ttu-id="fb7f4-650">Obtient le titre de la page actuellement affichée dans le **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-650">Gets the title of the page currently displayed in the **webview**.</span></span>  

<span data-ttu-id="fb7f4-651">Cette propriété est en lecture seule.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-651">This property is read-only.</span></span>  

```javascript
var documentTitle = webview.documentTitle;
```  

#### <span data-ttu-id="fb7f4-652">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-652">Property value</span></span>  

<span data-ttu-id="fb7f4-653">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-653">Type: **String**</span></span>  

<span data-ttu-id="fb7f4-654">Le titre de la page.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-654">The page title.</span></span>  

### <span data-ttu-id="fb7f4-655">hauteur</span><span class="sxs-lookup"><span data-stu-id="fb7f4-655">height</span></span>  

<span data-ttu-id="fb7f4-656">Obtient ou définit la hauteur du **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-656">Gets or sets the height of the **webview**.</span></span>  
...
#### <span data-ttu-id="fb7f4-657">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-657">Property value</span></span>  

<span data-ttu-id="fb7f4-658">Type: **nombre**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-658">Type: **Number**</span></span>  

<span data-ttu-id="fb7f4-659">Hauteur du **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-659">The height of the **webview**.</span></span>  

### <span data-ttu-id="fb7f4-660">processus</span><span class="sxs-lookup"><span data-stu-id="fb7f4-660">process</span></span>  

<span data-ttu-id="fb7f4-661">Obtient le processus **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-661">Gets the **webview** process.</span></span>  

<span data-ttu-id="fb7f4-662">Cette propriété est en lecture seule.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-662">This property is read-only.</span></span>  
...
#### <span data-ttu-id="fb7f4-663">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-663">Property value</span></span>  

<span data-ttu-id="fb7f4-664">Type: [MSWebViewProcess](./webview/MSWebViewProcess.md)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-664">Type: [MSWebViewProcess](./webview/MSWebViewProcess.md)</span></span>  

### <span data-ttu-id="fb7f4-665">settings</span><span class="sxs-lookup"><span data-stu-id="fb7f4-665">settings</span></span>  

<span data-ttu-id="fb7f4-666">Obtient un objet [MSWebViewSettings](./webview/MSWebViewSettings.md) qui contient les propriétés permettant d’activer ou de désactiver les fonctionnalités **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-666">Gets a [MSWebViewSettings](./webview/MSWebViewSettings.md) object that contains properties to enable or disable **webview** features.</span></span>  

<span data-ttu-id="fb7f4-667">Cette propriété est en lecture seule.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-667">This property is read-only.</span></span>  
...
#### <span data-ttu-id="fb7f4-668">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-668">Property value</span></span>  

<span data-ttu-id="fb7f4-669">Type: [MSWebViewSettings](./webview/MSWebViewSettings.md)</span><span class="sxs-lookup"><span data-stu-id="fb7f4-669">Type: [MSWebViewSettings](./webview/MSWebViewSettings.md)</span></span>  

<span data-ttu-id="fb7f4-670">Objet [MSWebViewSettings](./webview/MSWebViewSettings.md) qui contient les propriétés permettant d’activer ou de désactiver les fonctionnalités d' **affichage WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-670">A [MSWebViewSettings](./webview/MSWebViewSettings.md) object that contains properties to enable or disable **webview** features.</span></span>  

### <span data-ttu-id="fb7f4-671">src</span><span class="sxs-lookup"><span data-stu-id="fb7f4-671">src</span></span>  

<span data-ttu-id="fb7f4-672">Obtient ou définit la source URI (Uniform Resource Identifier) du contenu HTML à afficher dans le contrôle **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-672">Gets or sets the Uniform Resource Identifier (URI) source of the HTML content to display in the **webview** control.</span></span>  
...
#### <span data-ttu-id="fb7f4-673">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-673">Property value</span></span>  

<span data-ttu-id="fb7f4-674">Type: **chaîne**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-674">Type: **String**</span></span>  

<span data-ttu-id="fb7f4-675">Source URI du contenu HTML à afficher dans le contrôle **WebView** .</span><span class="sxs-lookup"><span data-stu-id="fb7f4-675">The URI source of the HTML content to display in the **webview** control.</span></span>  

### <span data-ttu-id="fb7f4-676">largeur</span><span class="sxs-lookup"><span data-stu-id="fb7f4-676">width</span></span>  

<span data-ttu-id="fb7f4-677">Obtient ou définit la largeur du **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-677">Gets or sets the width of the **webview**.</span></span>  
...
#### <span data-ttu-id="fb7f4-678">Valeur de propriété</span><span class="sxs-lookup"><span data-stu-id="fb7f4-678">Property value</span></span>  

<span data-ttu-id="fb7f4-679">Type: **nombre**</span><span class="sxs-lookup"><span data-stu-id="fb7f4-679">Type: **Number**</span></span>  

<span data-ttu-id="fb7f4-680">La largeur du **WebView**.</span><span class="sxs-lookup"><span data-stu-id="fb7f4-680">The width of the **webview**.</span></span>  
