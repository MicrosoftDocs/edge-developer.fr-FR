...
Dans le fichier [manifest.js][GithubMicrosoftEdgeExtensionsDemosColorChangerManifestjson] , incluez une clé de niveau supérieur pour `icons` .  
...
Vous devez ajouter le script en arrière-plan à la [manifest.jssur][GithubMicrosoftEdgeExtensionsDemosColorChangerManifestjson] le fichier.  Ajoutez la `background` clé suivante à votre manifeste.  
