...
Vous trouverez ci-dessous le lien permanent pour la liste des modifications suivante: [https://aka.ms/devguide_edgehtml_18](./whats-new.md) .
...
Pour plus d’informations sur l’utilisation du contenu multimédia hébergé sur votre site, consultez le guide [stratégies de lecture automatique](./browser-features/autoplay-policies.md) .
...
Enfin, les utilisateurs avec pouvoir peuvent constater l’apparition de la *visionneuse Web App* (anciennement *Win32WebViewHost*), une application système interne qui représente le WebView Win32, dans les emplacements suivants:
