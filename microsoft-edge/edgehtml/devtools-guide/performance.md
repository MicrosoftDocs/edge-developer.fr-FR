...
Utilisez les ****  /  boutons**Stop** de démarrage de la barre d’outils (ou `Ctrl+E` ) pour initier et terminer votre suivi des performances. Un indicateur vert s’affichent sous l’onglet **performance** pour indiquer qu’un enregistrement est en cours. 
