...
---
> [!NOTE]
> Cette documentation cible la [version héritée de Microsoft Edge][MicrosoftSupport44533505].  Pour plus d’informations sur le nouveau Microsoft Edge, voir [Microsoft Edge (chrome) devtools][DevtoolsGuideChromium].  
