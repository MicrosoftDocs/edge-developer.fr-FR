...
Les pages Web créent une **demande de paiement** en règle générale lorsque l’utilisateur démarre un processus de paiement en cliquant sur le bouton «acheter».  Le **Payment Request** [constructeur](/previous-versions/mt790440(v=vs.85)) de votre demande de paiement inclut methodData, les détails et les options.  
