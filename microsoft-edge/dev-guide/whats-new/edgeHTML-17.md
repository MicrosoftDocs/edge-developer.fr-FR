...
EdgeHTML 17 ajoute une prise en charge de différents rôles, États et propriétés à partir des [applications Internet enrichies accessibles (WAI-ARIA) 1,1](https://w3.org/TR/wai-aria-1.1), y compris les [flux](https://www.w3.org/TR/wai-aria-1.1#feed), le [formulaire](https://www.w3.org/TR/wai-aria-1.1#form), [Aria-haspopup](https://w3.org/TR/wai-aria-1.1#aria-haspopup), [Aria-PlaceHolder](https://w3.org/TR/wai-aria-1.1#aria-placeholder), et bien d’autres encore. Accédez à [la liste complète des mises à jour de Aria dans le changelog](https://developer.microsoft.com/microsoft-edge/platform/changelog/desktop/17134/?compareWith=16299).  Avec cette mise à jour, EdgeHTML 17 prend désormais en charge tous les rôles et attributs définis dans le WAI-ARIA 1,1.  Pour plus d’informations sur l’accessibilité dans Microsoft Edge, consultez les documentation sur l' [accessibilité](../../accessibility.md) .  
