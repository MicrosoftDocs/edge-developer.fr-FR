...
Vous trouverez ci-dessous une liste des nouvelles fonctionnalités et mises à jour fournies dans [EdgeHTML 17](https://blogs.windows.com/msedgedev/2018/04/30/edgehtml-17-april-2018-update/) Web Platform, dans le cadre de la [mise à jour 2018 de Windows 10 d’avril](https://blogs.windows.com/windowsexperience/2018/04/27/make-the-most-of-your-time-with-the-new-windows-10-update/) (04/2018, Build 17134). Pour plus d’informations sur les builds d’aperçu [Windows Insider](https://insider.windows.com/) spécifiques, voir le Guide de [Microsoft Edge changelog](https://developer.microsoft.com/microsoft-edge/platform/changelog/) et [les nouveautés dans EdgeHTML](../whats-new.md).

Vous trouverez ci-dessous le lien permanent pour la liste des modifications suivante: [https://aka.ms/devguide_edgehtml_17](https://aka.ms/devguide_edgehtml_17) .

## Fonctionnalités nouvelles et mises à jour 

### Rôles, États et événements ARIA 1,1

EdgeHTML 17 ajoute une prise en charge de différents rôles, États et propriétés à partir des [applications Internet enrichies accessibles (WAI-ARIA) 1,1](https://w3.org/TR/wai-aria-1.1/), y compris les [flux](https://www.w3.org/TR/wai-aria-1.1/#feed), le [formulaire](https://www.w3.org/TR/wai-aria-1.1/#form), [Aria-haspopup](https://w3.org/TR/wai-aria-1.1/#aria-haspopup), [Aria-PlaceHolder](https://w3.org/TR/wai-aria-1.1/#aria-placeholder), et bien d’autres encore. Accédez à [la liste complète des mises à jour de Aria dans le changelog](https://developer.microsoft.com/microsoft-edge/platform/changelog/desktop/17134/?compareWith=16299). Avec cette mise à jour, EdgeHTML 17 prend désormais en charge tous les rôles et attributs définis dans le WAI-ARIA 1,1. Pour plus d’informations sur l’accessibilité dans Microsoft Edge, consultez les documentation sur l' [accessibilité](https://docs.microsoft.com/microsoft-edge/accessibility) .
...
Pour plus d’informations sur les mises à jour d’extensions dans cette version, voir le billet de blog [nouvelles fonctionnalités pour les extensions de la mise à jour 2018 de Windows 10 d’avril](https://blogs.windows.com/msedgedev/2018/05/24/new-extension-features-april-2018-update-notifications-inprivate/).

### DevTools
Cette version du DevTools est fournie de deux manières: en tant qu’outils in-browser traditionnels ( `F12` ) pour Microsoft Edge et en tant qu' [application autonome Windows 10](../../devtools-guide/whats-new/edgehtml-17.md#microsoft-edge-devtools-app-preview) à partir du Microsoft Store.

![Application Microsoft Edge DevTools](../../devtools-protocol/media/microsoft-edge-devtools.png) 

Les outils sont également mis à jour à l’aide de plusieurs fonctionnalités majeures, notamment la prise en charge de base pour le [débogage à distance](../../devtools-guide/whats-new/edgehtml-17.md#devtools-protocol) (via notre nouveau [protocole devtools](../../devtools-guide/whats-new/edgehtml-17.md#devtools-protocol)) [, les](../../devtools-guide/whats-new/edgehtml-17.md#docking-to-the-right-in-microsoft-edge) [fonctionnalités de débogage](../../devtools-guide/whats-new/edgehtml-17.md#pwa-debugging)de [IndexedDB](../../devtools-guide/whats-new/edgehtml-17.md#indexeddb-inspection) Nous avons également continué la mise en route globale de la [refactorisation](./edgehtml-16.md) dans le cadre d’investissements en cours de performance et de fiabilité.
...
**Empreinte mémoire plus allégée**
 ...
 - (Ré-) différer l’analyse des [fonctions](https://github.com/Microsoft/ChakraCore/pull/4105) et [méthodes de flèche sur des littéraux d’objet](https://github.com/Microsoft/ChakraCore/pull/4136)
...
Pour en savoir plus, consultez la rubrique amélioration des performances des fonctions [*JavaScript et Webassembly dans EdgeHTML 17*](https://blogs.windows.com/msedgedev/2018/06/19/improved-javascript-webassembly-performance-edgehtml-17/#I4vzUJK2va54kSWl.97) .
...
* L’ajout de la [`setSinkId()`](https://developer.mozilla.org/docs/Web/API/HTMLMediaElement/setSinkId) méthode et de la [`sinkId`](https://developer.mozilla.org/docs/Web/API/HTMLMediaElement/sinkId) propriété permet aux développeurs de sélectionner le périphérique de sortie audio. (**Remarque**: il n’est pas encore disponible dans RTC)
...
Pour en savoir plus sur les travailleurs de services et les détails sur PWAs sur Windows 10, consultez notre [site Web sur](../../progressive-web-apps-edgehtml/index.md) les documents Windows.

### Sécurité Web
EdgeHTML 17 offre une prise en charge de l’intégrité des sous-ressources. [L’intégrité](https://developer.mozilla.org/docs/Web/Security/Subresource_Integrity) des sous-ressources est une fonction de vérification de la valeur de la propriété de source qui permet aux navigateurs de vérifier que les ressources récupérées (images, scripts, polices, etc.) sont transmises sans manipulation inattendue. 
...
Voici la liste complète des nouvelles API dans EdgeHTML 17. Ils sont répertoriés au format [nom de l’interface]. [nom de l’API].
