...
1.  Tout d’abord, `EdgeOptions` créez l’objet en copiant l’extrait de code suivant.  
    ...
    | Paramètre | Détails |    
    |:--- |:--- |  
    | `is_legacy` | Définir sur `false` , qui indique à Selenium que vous êtes à la base de Chromium navigateur Microsoft Edge navigateur. |  
