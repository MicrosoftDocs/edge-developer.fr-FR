...
1.  Activez le débogage de script pour les applications WebView2.  
    ...
    1.  Sous le **type de débogger,** choisissez **JavaScript (WebView2).**  
        ...
        :::image type="complex" source="./media/enb-js.png" alt-text="Visual Studio configuration du débogage" lightbox="./media/enb-js.png":::
           Visual Studio de **configuration de débogage**  
        :::image-end:::  
...
*   Déboguer des add-ins Office.  
    ...
    Si vous déboguer des add-ins Office, ouvrez le code source du Visual Studio code.  Ouvrez launch.jsdans votre application WebView2 et ajoutez l’extrait de code suivant pour joindre le débogger au add-in Office.
