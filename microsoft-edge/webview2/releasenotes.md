...
*   Pour plus d’informations sur la création d’applications Windows Forms, accédez au Guide de mise en place des formulaires [Windows][Webview2GettingstartedWinforms] et à la référence de formulaires WebView2 [Windows][DotnetApiMicrosoftWebWebview2Winforms] pour les API Windows formulaires spécifiques.  
...
[Webview2GettingstartedWinforms]: ./gettingstarted/winforms.md "Getting started with WebView2 in Windows Forms apps | Documents Microsoft"  
