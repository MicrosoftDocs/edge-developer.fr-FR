...
> public [CoreWebView2EnvironmentOptions](#corewebview2environmentoptions)(chaîne additionalBrowserArguments, language, String targetCompatibleBrowserVersion, bool allowSingleSignOnUsingOSPrimaryAccount)
...
* `allowSingleSignOnUsingOSPrimaryAccount` Valeur définie sur true si l’authentification unique est activée à l’aide du compte principal du système d’exploitation de l’utilisateur final. Par défaut, la valeur est false.
