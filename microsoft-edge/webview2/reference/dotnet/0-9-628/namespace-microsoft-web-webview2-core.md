...
CoreWebView2HttpHeadersCollectionIterator | Itérateur pour une collection d’en-têtes HTTP.
CoreWebView2HttpRequestHeaders | En-têtes de requête HTTP.
CoreWebView2HttpResponseHeaders | En-têtes de réponse HTTP.
...
CoreWebView2WebResourceRequest | Une requête HTTP utilisée avec l’événement WebResourceRequested.
CoreWebView2WebResourceRequestedEventArgs | Arguments d’événement pour l’événement WebResourceRequested.
CoreWebView2WebResourceResponse | Réponse HTTP utilisée avec l’événement WebResourceRequested.
CoreWebView2WebResourceResponseReceivedEventArgs | Arguments d’événement pour l’événement WebResourceResponseReceived.
