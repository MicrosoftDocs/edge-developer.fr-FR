...
> valeur publique HRESULT [get_ParentWindow](#get_parentwindow)(HWND * FenêtreParent)
...
> [put_ParentWindows](#put_parentwindow)par le biais du public HRESULT
