...
[put_AllowSingleSignOnUsingOSPrimaryAccount](#put_allowsinglesignonusingosprimaryaccount) | Définissez la propriété AllowSingleSignOnUsingOSPrimaryAccount.
[put_Language](#put_language) | Définissez la propriété Language.
[put_TargetCompatibleBrowserVersion](#put_targetcompatiblebrowserversion) | Définissez la propriété TargetCompatibleBrowserVersion.
...
> [get_AllowSingleSignOnUsingOSPrimaryAccounts](#get_allowsinglesignonusingosprimaryaccount)par l’autorisation public HRESULT
...
Définissez la propriété AllowSingleSignOnUsingOSPrimaryAccount.

> [put_AllowSingleSignOnUsingOSPrimaryAccounts](#put_allowsinglesignonusingosprimaryaccount)par l’autorisation public HRESULT
...
Définissez la propriété TargetCompatibleBrowserVersion.
